---
source_file: 03-navbar-offcanvas-collapsed-and-behind-backdrop.md
title: Main-nav offcanvas (`#bdNavbar`) renders empty on mobile — collapsed panel
  + painted behind the backdrop
---
