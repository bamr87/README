...
description: An open-source platform that takes you from zer0 to her0 in IT — gamified
  quests, hands-on practice, and seven principles that shape how we build and learn.
draft: false
excerpt: IT-Journey is an open-source platform that turns curiosity into capability
  — a free, gamified path from your first command to systems you design yourself.
