...
description: Forge a new IT-Journey quest idea with live guidance — duplicate radar,
  readiness scoring, and autocomplete — then submit it for AI refinement in one click.
draft: false
keywords:
- quest ideas
- submit a quest
