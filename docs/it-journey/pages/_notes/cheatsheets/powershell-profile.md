...
description: Set persistent environment variables, sync your PowerShell profile from
  a GitHub gist, and reload the shell — the commands worth keeping close.
draft: false
excerpt: Persistent environment variables, a profile synced from a GitHub gist, and
  the reload commands that go with them.
keywords:
  primary:
  - powershell profile
...
source_file: powershell-profile.md
tags:
- powershell
- windows
- profile
