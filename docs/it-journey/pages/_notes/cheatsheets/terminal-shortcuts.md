...
description: Complete reference for terminal shortcuts on macOS, Linux, and Windows.
  Master navigation, editing, and productivity for Bash, Zsh, and PowerShell.
difficulty: 🟢 Easy
draft: false
...
- /docs/terminal/
source_file: terminal-shortcuts.md
tags:
- terminal
- shortcuts
- bash
