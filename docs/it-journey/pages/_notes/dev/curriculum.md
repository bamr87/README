...
description: 'The IT-Journey curriculum philosophy: you cannot teach what you do not
  know, so build to teach — and the sequence that follows from that.'
draft: false
excerpt: The IT-Journey curriculum is built backwards from teaching — if you cannot
  explain it, you don't know it yet. The Zero→Foundation→Tools→Projects→Specialization
  sequence follows from that constraint.
keywords:
- curriculum design
