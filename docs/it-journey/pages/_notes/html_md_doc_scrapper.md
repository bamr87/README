...
- python
- web-scraping
date: 2024-05-21 12:29:08+00:00
description: A simple web scraping project to convert HTML to markdown using Python
  with Beautiful Soup and markdownify
draft: false
lastmod: 2025-07-03 16:40:00+00:00
source_file: html_md_doc_scrapper.md
tags:
- python
- web-scraping
- html
...
```
    ...
    /Users/bamr87/Library/Python/3.9/lib/python/site-packages/urllib3/__init__.py:35: NotOpenSSLWarning: urllib3 v2 only supports OpenSSL 1.1.1+, currently the 'ssl' module is compiled with 'LibreSSL 2.8.3'. See: https://github.com/urllib3/urllib3/issues/3020
      warnings.warn(
