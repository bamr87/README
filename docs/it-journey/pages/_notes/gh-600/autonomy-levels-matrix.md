...
description: Quick reference for the five-level autonomy spectrum (L0–L4) — task classification
  criteria, appropriate use cases, and guardrail requirements for each level.
draft: false
lastmod: '2026-05-17T00:00:00.000Z'
layout: default
permalink: /notes/gh-600/autonomy-levels-matrix/
source_file: autonomy-levels-matrix.md
tags:
- gh-600
- autonomy
- responsible-ai
