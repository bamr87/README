...
description: Quick reference for activating, configuring, and constraining the GitHub
  Copilot coding agent — including AGENTS.md structure, copilot-instructions.md, and
  permission scopes.
draft: false
lastmod: '2026-05-17T00:00:00.000Z'
layout: default
permalink: /notes/gh-600/copilot-coding-agent-cheatsheet/
source_file: copilot-coding-agent-cheatsheet.md
tags:
- gh-600
- copilot
- coding-agent
