...
description: Complete breakdown of all 6 domains and 19 sub-skills for GH-600, each
  linked to its corresponding agentic quest in the codex arc.
draft: false
keywords:
- gh-600
- agentic-ai
...
source_file: skills-measured.md
tags:
- gh-600
- agentic-ai
- skills-measured
