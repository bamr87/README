...
description: 'Curated resources for GH-600 exam preparation: Microsoft Learn paths,
  GitHub documentation, MCP specification, and the GitHub Models API.'
draft: false
keywords:
- gh-600
- agentic-ai
...
source_file: recommended-resources.md
tags:
- gh-600
- agentic-ai
- resources
