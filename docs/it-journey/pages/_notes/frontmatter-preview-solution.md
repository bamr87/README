...
description: Simplified Front Matter CMS preview wiring for IT-Journey — a `/preview/<collection>/<filename>/`
  directory pattern that survives custom Jekyll permalinks.
draft: false
keywords:
- frontmatter cms
- jekyll preview
...
source_file: frontmatter-preview-solution.md
tags:
- frontmatter
- jekyll
- preview
- cms
- tooling
title: Front Matter Preview Configuration
---
