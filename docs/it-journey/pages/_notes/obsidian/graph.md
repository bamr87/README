...
description: Interactive knowledge graph visualizing all IT-Journey pages connected
  through Obsidian-style wiki links, backlinks, and cross-references.
draft: false
excerpt: Explore the IT-Journey knowledge graph generated from wiki links across docs,
  notes, quests, and posts.
keywords:
  primary:
  - obsidian graph
  - knowledge graph
...
local_graph: false
permalink: /notes/obsidian/graph/
redirect_from:
- /docs/obsidian/graph/
sidebar:
  nav: auto
