...
description: Use Obsidian-style wiki links, backlinks, embeds, and interactive graph
  views across all IT-Journey docs, quests, notes, and posts.
draft: false
excerpt: Lightweight guide to the Obsidian-style knowledge features provided by the
  zer0-mistakes theme.
keywords:
  primary:
  - obsidian
