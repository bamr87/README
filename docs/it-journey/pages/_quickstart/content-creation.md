...
description: Create blog posts, quests, documentation, and other content types with
  proper frontmatter, naming conventions, and file organization.
difficulty: 🟢 Easy
draft: false
estimatedTime: 20-30 minutes
excerpt: Create blog posts, quests, and documentation with proper frontmatter, naming
  conventions, and file organization for Jekyll collections.
keywords:
  primary:
  ...
  - documentation
  - content types
lastmod: 2026-04-02 03:14:50.929000+00:00
...
source_file: content-creation.md
tags:
- content
- frontmatter
- posts
