...
categories:
- quickstart
date: 2025-11-20 18:53:39+00:00
description: Quickstart guide for installing Charm tools (Gum, Glow) and building
  a custom terminal dashboard for the IT-Journey repository.
difficulty: 🟡 Medium
draft: false
estimatedTime: 20-30 minutes
excerpt: Install and configure Charm terminal tools (Gum and Glow) to build a custom
  interactive dashboard for the IT-Journey repository.
keywords:
  primary:
  - charm tools
  - terminal interface
  ...
  - terminal dashboard
  - interactive cli
lastmod: 2026-04-02 03:14:50.894000+00:00
