...
description: Complete walkthrough of _config.yml — site identity, theme skins, collections,
  default frontmatter, plugins, comments, and analytics.
difficulty: 🟡 Medium
draft: false
estimatedTime: 30-45 minutes
excerpt: Walkthrough of _config.yml covering site identity, theme skins, collections,
  frontmatter defaults, plugins, comments, and analytics configuration.
keywords:
  primary:
...
lastmod: 2026-04-02 03:14:50.902000+00:00
...
source_file: site-configuration.md
tags:
- configuration
- yaml
- jekyll
- theme
title: _config_dev.yml
---
