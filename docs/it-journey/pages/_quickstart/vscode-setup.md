...
description: Set up Visual Studio Code with recommended extensions, Front Matter CMS,
  pre-configured tasks, and debug configurations for Jekyll development.
difficulty: 🟢 Easy
draft: false
...
keywords:
  ...
  - tasks
  - debug configuration
lastmod: 2026-04-02 03:14:50.912000+00:00
