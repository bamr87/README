...
description: Understand how the zer0-mistakes theme builds pages — layouts, includes,
  Liquid templating, data files, and the Jekyll build pipeline.
difficulty: 🟡 Medium
draft: false
estimatedTime: 30-40 minutes
excerpt: Explore the zer0-mistakes theme's layout hierarchy, includes, Liquid templating,
  and YAML data files — and how Jekyll assembles your pages.
keywords:
  primary:
  ...
  - data files
  - zer0-mistakes theme
lastmod: 2026-04-02 03:14:50.920000+00:00
...
source_file: theme-architecture.md
tags:
- jekyll
- liquid
- layouts
