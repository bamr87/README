...
categories:
- quickstart
date: 2021-11-09 17:30:29+00:00
description: Install Jekyll with the zer0-mistakes theme — via Gemfile or Docker —
  then verify your site builds and serves correctly.
difficulty: 🟢 Easy
draft: false
estimatedTime: 15-30 minutes
excerpt: Install Jekyll with the zer0-mistakes theme via Gemfile or Docker, configure
  Bundler, and verify your local site builds and serves correctly.
keywords:
  primary:
  - jekyll installation
  - zer0-mistakes theme
  ...
  - gemfile
  - ruby gems
lastmod: 2026-04-02 03:14:50.876000+00:00
...
sidebar:
  nav: quickstart
slug: jekyll
source_file: jekyll-setup.md
tags:
- jekyll
- ruby
- theme
- installation
title: Install all dependencies specified in Gemfile
---
