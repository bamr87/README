...
description: Deploy your Jekyll site to GitHub Pages, Azure Static Web Apps, or any
  static hosting provider — with custom domain configuration.
difficulty: 🟡 Medium
draft: false
estimatedTime: 20-30 minutes
excerpt: Deploy your Jekyll site to GitHub Pages, Azure Static Web Apps, or a custom
  hosting provider, with optional custom domain configuration.
keywords:
  primary:
  - jekyll deployment
  - github pages
  ...
  - CNAME
  - static hosting
lastmod: 2026-04-02 03:14:50.958000+00:00
