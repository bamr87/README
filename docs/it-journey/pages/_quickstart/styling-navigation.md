...
description: Customize your site's look with theme skins, colors, and CSS — then configure
  navigation menus, sidebars, search, and comments.
difficulty: 🟡 Medium
draft: false
estimatedTime: 25-35 minutes
excerpt: Customize your site's look with theme skins, CSS, and colors — then configure
  navigation menus, sidebars, search, and comment systems.
keywords:
  primary:
  - jekyll styling
  - site navigation
  ...
  - sidebar config
  - giscus comments
lastmod: 2026-04-02 03:14:50.937000+00:00
...
source_file: styling-navigation.md
tags:
- styling
- navigation
- css
