...
- Documentation
date: 2023-11-27 04:08:17+00:00
description: Complete guide to creating professional CVs and resumes using LaTeX with
  Visual Studio Code integration and GitHub version control
draft: false
excerpt: Learn to create stunning, professional CVs using LaTeX, integrated with VS
  Code for the ultimate document creation workflow
keywords:
  primary:
  - latex cv
  - resume creation
...
source_file: 2023-11-04-latex-cv-professional-resume.md
