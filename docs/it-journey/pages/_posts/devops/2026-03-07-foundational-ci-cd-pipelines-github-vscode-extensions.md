...
date: 2026-03-07 16:17:32+00:00
description: Learn how to build robust CI/CD pipelines using GitHub Actions for VS
  Code extension development. A real-world walkthrough using the vs-sonic-pi extension,
  covering linting, testing, building, and automated marketplace publishing.
difficulty: 🟡 Intermediate
draft: false
estimated_reading_time: 15-20 minutes
excerpt: Build a production-ready CI/CD pipeline for a VS Code extension using GitHub
  Actions — from lint and test to automated marketplace publishing.
keywords:
  primary:
  ...
  - automated testing
  - node.js ci pipeline
lastmod: 2026-03-08 02:59:00.430000+00:00
learning_outcomes:
...
section: DevOps
snippet: Ship your VS Code extension with confidence using a two-workflow CI/CD pipeline
  on GitHub Actions.
source_file: 2026-03-07-foundational-ci-cd-pipelines-github-vscode-extensions.md
sub-title: From lint and test to automated Marketplace publishing with real-world
  examples
tags:
- github-actions
- ci-cd
