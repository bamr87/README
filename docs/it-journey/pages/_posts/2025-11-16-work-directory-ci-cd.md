...
date: 2025-11-16 08:17:59+00:00
description: Master the work/ directory pattern for fast, isolated, cacheable, and
  disposable CI/CD workspaces that maximize build speed and minimize flakiness across
  any pipeline.
difficulty: 🟡 Intermediate
estimated_reading_time: 25-35 minutes
excerpt: The work/ directory pattern provides a structured, performance-optimized
  approach to CI/CD builds—separating persistent caches from disposable artifacts
  while maintaining reproducibility and speed.
keywords:
  primary:
  - work-directory
  - ci-cd-optimization
  ...
  - workspace-isolation
  - artifact-management
lastmod: 2025-11-23 00:14:48.317000+00:00
learning_outcomes:
...
section: DevOps
snippet: In CI/CD, work/ is your high-speed conveyor belt—feed it materials, cache
  tools, produce goods, ship reports, wipe clean.
source_file: 2025-11-16-work-directory-ci-cd.md
