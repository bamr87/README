...
description: 'Drive Claude Code from GitHub Actions as an oath-bound worker: one composite
  action for auth and invocation, a named agent role file, a prompt that is a contract,
  and a report artifact — while git stays in the workflow''s hands.'
difficulty: 🟡 Medium
draft: false
...
skill_focus: devops
source_file: ouroboros-loop-03-summon-the-golem.md
tags:
- '0011'
- claude-code
- main_quest
...
- automation
- gamified-learning
title: .github/actions/claude-run/action.yml
---
