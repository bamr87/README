...
description: 'Master prompt engineering for VS Code Copilot: structured RCTF patterns,
...
source_file: prompt-crystal-mastery-vscode-copilot.md
...
- hands-on
- gamified-learning
title: Install VS Code Copilot extensions via CLI
validation_criteria:
...
- [ ] **⚡ Implement Prompting Techniques** - Apply zero-shot, few-shot, and Chain-of-Thought patterns effectively
- [ ] **🛠️ Configure Project Context** - Set up `.github/copilot-instructions.md` for persistent Copilot intelligence
- [ ] **🔗 Build Template Library** - Create reusable prompt templates in `.github/prompts/` with variables
- [ ] **📊 Apply PDCA Iteration** - Use the Plan-Do-Check-Act cycle to systematically improve prompt quality
...
- [ ] **🌐 Cross-Platform Templates** - Create prompts that work across macOS, Windows, and Linux
...
### 🎭 The RCTF Pattern: Your Primary Spell
...
### 🔍 Knowledge Check: Prompting Techniques
...
### 🔍 Knowledge Check: Project Configuration
...
### 🔍 Knowledge Check: Template Library
...
### 🔍 Knowledge Check: PDCA Iteration
...
## ✅ Quest Validation & Knowledge Checks
...
- **📚 Template Architect** - Built reusable prompt library
...
- 📋 **Reusable Prompt Template Development** - Build and share prompt libraries
- ♻️ **Kaizen-Driven Prompt Iteration** - Continuously improve prompt quality
- 🔍 **Prompt Quality Assessment** - Score and validate prompt effectiveness

### 📈 Progression Points: +175 XP
