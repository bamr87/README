...
description: Your comprehensive guide to IT mastery through gamified learning adventures.
  Choose your path, level up your skills, and become an IT wizard.
draft: false
keywords:
- init
- hello world
...
- [📖 Codex Glossary](/quests/codex/glossary/) — dictionary of digital spells and terms
- [🗺️ World Map](/quests/codex/world-map/) — navigate the digital realms
- [🎒 Inventory](/quests/inventory/) — track and export your learner progress
- [🛠️ Tools Collection](/quests/tools/) — cross-level version control and workflow quests
- [🏰 Overworld Hub](/quests/home/) — your central command center
...
2. **Fork the repository:** [Fork it-journey](https://github.com/bamr87/it-journey/fork)
3. **Choose your first quest:** Start at the [`0000` Foundation & Init World hub](/quests/0000/) and pick a quest from its grid.

### For Experienced Adventurers

1. **Explore the [World Map](/quests/codex/world-map/)** for orientation.
...
- **Use the canonical taxonomy** — a valid `level` (`0000`–`1111`), one of the four difficulties (🟢 Easy / 🟡 Medium / 🔴 Hard / ⚔️ Epic), and the required frontmatter fields. The validator and `quest_registry.py` enforce this.
...
- 📖 Check the [Glossary](/quests/codex/glossary/) for term definitions.
- 🗺️ Consult the [World Map](/quests/codex/world-map/) for navigation.
