...
description: 'Lead engineers without a title: set a technical vision, frame and close
...
prerequisites:
  ...
  - You have shipped non-trivial systems and want to multiply your impact through
    others
  system_requirements:
...
source_file: technical-leadership.md
...
- delegation
- gamified-learning
title: Keep your leadership artifacts in a versioned, plain-text vault
validation_criteria:
