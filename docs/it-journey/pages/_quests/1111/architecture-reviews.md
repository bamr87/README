...
description: Lead effective architecture reviews and design discussions. Master RFC
  processes, technical debt assessment, system evaluation, and architectural decision
  records.
difficulty: 🔴 Hard
draft: true
...
level: '1111'
permalink: /quests/level-1111-architecture-reviews/
prerequisites:
