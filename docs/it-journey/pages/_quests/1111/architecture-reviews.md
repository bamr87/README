...
description: Run effective architecture and design reviews. Learn to facilitate trade-off
...
rewards:
  badges:
  - 🏆 Keeper of the Blueprints - Recorded decisions future builders will thank you
    for
  - 🛡️ Master of the Round Table - Facilitated a review that critiqued ideas, not
    people
...
source_file: architecture-reviews.md
...
- trade-offs
- gamified-learning
title: Store ADRs in the repo; adr-tools automates numbering and templating
validation_criteria:
