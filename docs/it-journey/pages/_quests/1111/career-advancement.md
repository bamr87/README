...
description: Advance your engineering career deliberately. Learn the IC vs management
...
prerequisites:
  ...
  - You are ready to steer your career instead of drifting
  system_requirements:
  - A document tool for a brag doc and a promotion case
  - Access to your company's leveling rubric if one exists
...
skill_focus: career
source_file: career-advancement.md
sub_title: 'Level 1111 (15) Quest: Main Quest - Career Advancement'
tags:
- '1111'
- career
- main_quest
...
- personal-brand
- gamified-learning
title: A private, append-only brag doc is the single best career habit
validation_criteria:
  completion_requirements:
  - All primary objectives completed
  - A brag doc started and a promotion case mapped to a rubric
  knowledge_checks:
  - Understands the IC vs management fork and that it is reversible
  - Can describe how staff+ impact differs from senior impact
  skill_demonstrations:
  - Can map their work to a leveling rubric
  - Can run a salary negotiation without anchoring against themselves
---
...
```bash
# A private, append-only brag doc is the single best career habit
mkdir -p ~/career/{brag-doc,promo,offers}
cd ~/career && git init
echo "# Brag Doc — running log of impact" > brag-doc/$(date +%Y).md
```
...
```powershell
mkdir $HOME\career\brag-doc, $HOME\career\promo, $HOME\career\offers
Set-Location $HOME\career
git init
"# Brag Doc — running log of impact" | Out-File "brag-doc\$(Get-Date -f yyyy).md"
```
...
```bash
# Keep career docs private but backed up — a private repo or encrypted note
# Update the brag doc the DAY something ships, while details are fresh.
echo "Add to your brag doc every time you ship, fix, or help — same day."
```
...
- 🎯 [Architecture Reviews](/quests/1111/architecture-reviews/) - Show the judgment that earns the next level

**Explore Side Adventures**:
- ⚔️ [Mentorship Programs](/quests/1111/mentorship-programs/) - Lift others as you rise
- ⚔️ [Tech Speaking and Writing](/quests/1111/tech-speaking-writing/) - Build the brand that opens doors
...
- [StaffEng - the staff engineer path](https://staffeng.com/guides/) - Definitive guide to IC leveling and promotion
- [progression.fyi - public leveling rubrics](https://www.progression.fyi/) - Real engineering ladders to study
- [levels.fyi - compensation data](https://www.levels.fyi/) - Total-comp benchmarks by level and company

### Community Resources
- [Julia Evans - Get your work recognized: write a brag document](https://jvns.ca/blog/brag-documents/) - The canonical brag-doc post
- [Charity Majors - The engineer/manager pendulum](https://charity.wtf/2017/05/11/the-engineer-manager-pendulum/) - Why the fork is reversible
- [Patrick McKenzie - Salary Negotiation](https://www.kalzumeus.com/2012/01/23/salary-negotiation/) - The classic, thorough negotiation guide

### Learning Materials
- [The Staff Engineer's Path - Tanya Reilly](https://www.oreilly.com/library/view/the-staff-engineers/9781098118723/) - The IC senior track in depth
- [Never Split the Difference - Chris Voss](https://www.blackswanltd.com/never-split-the-difference) - Negotiation tactics from a hostage negotiator
