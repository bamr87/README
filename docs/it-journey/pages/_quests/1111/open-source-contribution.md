...
description: Contribute to and maintain open source. Learn the contribution workflow,
  community norms, reviewing and triaging issues, and the basics of software licensing.
difficulty: 🔴 Hard
draft: false
...
source_file: open-source-contribution.md
...
- maintainership
- gamified-learning
title: Install Git and the GitHub CLI for a smooth contribution flow
validation_criteria:
