...
description: 'Build effective engineering mentorship: learn mentoring models, feedback
  that lands, growth frameworks, and how mentoring differs from sponsorship.'
difficulty: 🔴 Hard
draft: false
...
source_file: mentorship-programs.md
...
- growth
- gamified-learning
title: A private, versioned mentoring journal protects continuity
validation_criteria:
