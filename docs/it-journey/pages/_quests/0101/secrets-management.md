...
description: Handle CI secrets securely. Learn OIDC versus long-lived credentials,
...
preview: images/previews/secrets-management-secure-configuration-handling-d.webp
...
source_file: secrets-management.md
...
- hands-on
- gamified-learning
title: Install the GitHub CLI to manage repository secrets from the terminal
validation_criteria:
