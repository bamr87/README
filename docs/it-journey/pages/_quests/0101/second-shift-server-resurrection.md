...
description: Repurpose a decade-old desktop into an always-available Docker host —
  Wake-on-LAN necromancy, a boot-to-tmux console, LAN-scoped firewalling, and the
...
skill_focus: devops
source_file: second-shift-server-resurrection.md
