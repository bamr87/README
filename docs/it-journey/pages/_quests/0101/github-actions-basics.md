...
description: 'Build GitHub Actions workflows from scratch: master jobs, steps, triggers,
  runners, secrets, and matrix builds to automate your testing and deployment.'
difficulty: 🟡 Medium
draft: false
...
skill_focus: devops
source_file: github-actions-basics.md
...
- hands-on
- gamified-learning
title: Install the GitHub CLI to view runs from your terminal
validation_criteria:
