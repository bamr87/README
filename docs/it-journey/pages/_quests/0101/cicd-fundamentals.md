...
description: 'Master CI/CD fundamentals: the build-test-deploy flow, how continuous
  integration, delivery, and deployment differ, pipeline stages, and fast feedback
  loops.'
difficulty: 🟡 Medium
draft: false
...
skill_focus: devops
source_file: cicd-fundamentals.md
...
- hands-on
- gamified-learning
title: Install Git and a runtime using Homebrew
validation_criteria:
