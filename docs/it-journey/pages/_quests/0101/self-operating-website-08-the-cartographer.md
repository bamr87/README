...
description: 'Keep the product thin: tell a product bug from a platform bug, and file
  the platform one upstream as a maintainer-ready issue instead of patching around
  it in your own repo.'
difficulty: 🟡 Medium
draft: false
...
source_file: self-operating-website-08-the-cartographer.md
tags:
- '0101'
- github
- bonus_quest
...
- ci-cd
- gamified-learning
title: triage.sh — does the bug live in MY repo or the THEME?
---
