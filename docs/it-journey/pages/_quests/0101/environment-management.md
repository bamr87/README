...
description: Manage multiple deployment environments. Achieve dev/staging/prod parity,
...
skill_focus: devops
source_file: environment-management.md
...
- hands-on
- gamified-learning
title: Set and read an environment variable in zsh/bash
validation_criteria:
