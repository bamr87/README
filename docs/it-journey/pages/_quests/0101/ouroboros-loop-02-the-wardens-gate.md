...
description: 'Give your loop the discipline of OFF-by-default: a gate job that checks
  a kill-switch variable and auth before anything runs, least-privilege permissions,
  and the caller-permissions rule that kills whole workflows at startup.'
difficulty: 🟡 Medium
draft: false
...
skill_focus: devops
source_file: ouroboros-loop-02-the-wardens-gate.md
tags:
- '0101'
- github-actions
- main_quest
...
- security
- gamified-learning
title: .github/workflows/first-turn.yml  (additions)
---
