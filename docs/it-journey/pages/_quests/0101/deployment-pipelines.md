...
description: Build robust deployment pipelines for production releases. Learn environments,
...
- hands-on
- gamified-learning
title: Install the GitHub CLI to manage environments and deployments
validation_criteria:
