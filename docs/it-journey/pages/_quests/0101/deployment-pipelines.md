...
description: Build robust deployment pipelines for production releases. Learn blue-green
  deployments, rolling updates, canary releases, and automated rollback strategies.
difficulty: 🟡 Medium
draft: true
...
skill_focus:
- devops
source_file: deployment-pipelines.md
