...
description: 'Master Bootstrap 5: use the 12-column grid, prebuilt components, and
...
source_file: bootstrap-framework.md
...
- hands-on
- beginner
title: Create a folder and a single HTML file
validation_criteria:
