...
description: Go beyond basic Markdown with tables, footnotes, fenced code, callouts,
...
source_file: advanced-markdown.md
...
- hands-on
- beginner
title: Create a Markdown file to experiment in
validation_criteria:
