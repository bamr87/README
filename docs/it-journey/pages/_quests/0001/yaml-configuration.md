...
description: 'Master YAML for Jekyll: write front matter, configure _config.yml, build
...
source_file: yaml-configuration.md
...
- hands-on
- beginner
title: Install yamllint to validate your YAML
validation_criteria:
