...
description: 'Publish a Jekyll site to the world with GitHub Pages: repository setup,
...
source_file: github-pages-basics.md
...
- hands-on
- beginner
title: Authenticate the GitHub CLI (one-time)
validation_criteria:
