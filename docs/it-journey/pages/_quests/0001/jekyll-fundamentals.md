...
description: 'Master Jekyll static site generation: install Ruby and Jekyll, learn
  the project structure and collections, then build and serve a fast, secure site.'
difficulty: 🟢 Easy
draft: false
...
source_file: jekyll-fundamentals.md
...
- hands-on
- beginner
title: Install a modern Ruby with Homebrew (the system Ruby is too old)
validation_criteria:
