...
description: 'Master technical SEO for Jekyll: write meta tags, generate sitemaps
...
source_file: seo-optimization.md
...
- hands-on
- beginner
title: In an existing Jekyll site, add the SEO and sitemap plugins
validation_criteria:
