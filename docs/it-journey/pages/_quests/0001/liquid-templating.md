...
description: 'Master Liquid, the templating language behind Jekyll: variables, filters,
  loops, conditionals, includes, and layouts that render dynamic pages at build time.'
difficulty: 🟡 Medium
draft: false
...
source_file: liquid-templating.md
...
- hands-on
- beginner
title: Serve your site with live reload so Liquid edits appear instantly
validation_criteria:
