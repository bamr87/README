...
description: Raise a Jekyll site on a remote theme and GitHub Pages, encode a machine-readable
  brand and voice, and teach it to write a shareable dispatch at the end of every
  working session.
difficulty: 🟢 Easy
draft: false
...
source_file: self-operating-website-01-the-summoning.md
tags:
- '0001'
- jekyll
- bonus_quest
