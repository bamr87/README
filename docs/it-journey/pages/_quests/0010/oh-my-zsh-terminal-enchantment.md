...
description: Install Oh-My-Zsh, then customize your terminal with themes, plugins,
...
skill_focus: devops
source_file: oh-my-zsh-terminal-enchantment.md
...
- command-line-efficiency
- gamified-learning
title: macOS-specific preparation
validation_criteria:
