...
description: Install Nerd Fonts on macOS, Linux, and Windows, then configure your
...
source_file: nerd-font-enchantment.md
...
- linux
- windows
title: Using Homebrew (recommended method)
validation_criteria:
