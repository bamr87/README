...
description: Study how the bashcrawl terminal dungeon is built from directories, scrolls,
  and scripts, then extend it with new rooms, hidden secrets, and combat.
difficulty: 🟡 Medium
draft: false
...
- shell-scripting
- '0'
title: 'Inside a treasure script, reveal a hidden room:'
validation_criteria:
