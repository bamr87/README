...
description: 'Build your first autonomous loop from scratch: a tiny repo of runnable
  recipes, a deterministic checker, a date-rotating daily workflow, and a committed
...
skill_focus: devops
source_file: ouroboros-loop-01-the-first-turn.md
tags:
- '0000'
- github-actions
- main_quest
...
- loops
- gamified-learning
title: Forge the repository and clone it
---
