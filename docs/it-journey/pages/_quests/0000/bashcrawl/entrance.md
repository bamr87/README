...
excerpt: Start Bashcrawl by using pwd, ls, cd, and cat to read the first scroll, collect
  the brass key, and enter the dungeon.
fmContentType: quest
keywords:
  primary:
  - pwd command
...
- navigation
- '0000'
title: 'Output: /home/<user>/bashcrawl/ENTRANCE  (or similar)'
validation_criteria:
