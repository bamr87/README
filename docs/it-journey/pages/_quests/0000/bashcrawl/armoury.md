...
description: Learn chmod, file permissions, and script execution in Bashcrawl's Armoury.
  Brew a health potion and wield a sword for your first combat encounter.
difficulty: 🟡 Medium
draft: false
estimated_time: 25-30 minutes
excerpt: Master chmod, read permission bits, and execute armoury scripts to brew potions,
  equip your sword, and unlock the next chamber.
fmContentType: quest
keywords:
  primary:
  - chmod command
...
- chmod
- '0000'
title: -rw-r--r-- 1 user group  512 Jan  1 00:00 potion
validation_criteria:
