...
excerpt: Defeat the stone statue by using let, expr, and arithmetic expansion to solve
  Bash math challenges and unlock the Rift.
fmContentType: quest
keywords:
  primary:
  - bash arithmetic
