...
excerpt: Practice mkdir, touch, echo redirection, cp, mv, and rm to construct workshop
  artifacts and advance deeper into Bashcrawl.
fmContentType: quest
keywords:
  primary:
  - mkdir command
