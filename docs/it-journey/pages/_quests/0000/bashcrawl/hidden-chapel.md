...
description: Uncover the Hidden Chapel with ls -a, explore the courtyard, aviary,
  hall, and graveyard. Use man pages and --help to defeat the monster and claim the
  tome.
difficulty: 🔴 Hard
draft: false
estimated_time: 35-45 minutes
excerpt: Reveal hidden dot-directories, consult man pages, and use command help systems
  to defeat the chapel monster and claim the tome.
fmContentType: quest
keywords:
  primary:
  - ls -a hidden files
...
- man-pages
- '0000'
title: regular_file  visible_dir/
validation_criteria:
