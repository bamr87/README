...
excerpt: Build and inspect symbolic-link portals with ln -s, ls -l, and readlink to
  traverse the Scrap Heap and recover the portal crystal.
fmContentType: quest
keywords:
  primary:
...
- ln
- '0000'
title: broken_sword  empty_bottle  portal_mirror@  scrap_pile/  crystal_hint
validation_criteria:
