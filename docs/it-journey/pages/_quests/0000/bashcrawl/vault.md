...
excerpt: Set, export, and inspect environment variables to solve the vault goblet
  puzzle, survive the ghost, and claim the key fragment.
fmContentType: quest
keywords:
  primary:
  - bash export command
...
- export
- '0000'
title: 'Local — child scripts cannot see this:'
validation_criteria:
