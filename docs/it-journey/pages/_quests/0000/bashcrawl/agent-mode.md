...
excerpt: Automate Bashcrawl runs with agent mode, scripted commands, screenshot capture,
  and an optional open-source contribution finale.
fmContentType: quest
keywords:
  primary:
...
- contribution
- '0000'
title: Play through the dungeon normally (--classic runs in plain, non-TUI mode)
validation_criteria:
