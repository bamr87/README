...
excerpt: Conquer the final Rift by chaining commands, piping output, and redirecting
  streams to defeat both bosses and finish Bashcrawl.
fmContentType: quest
keywords:
  primary:
  - bash pipes
...
- redirection
- '0000'
title: The Rift gate requires all four fragments
validation_criteria:
