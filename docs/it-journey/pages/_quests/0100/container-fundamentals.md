...
description: 'Master Docker container fundamentals: images versus containers, writing
...
skill_focus: devops
source_file: container-fundamentals.md
...
- hands-on
- gamified-learning
title: Install Docker Desktop (includes the engine, CLI, and a small VM)
validation_criteria:
