...
description: 'Master Kubernetes basics: cluster architecture, the control plane and
...
skill_focus: devops
source_file: kubernetes-fundamentals.md
...
- hands-on
- gamified-learning
title: Install kubectl and a local cluster tool with Homebrew
validation_criteria:
