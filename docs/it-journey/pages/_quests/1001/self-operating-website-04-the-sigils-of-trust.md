...
description: 'Wire authentication and secrets so the robot can act but never escalate:
  OAuth versus API keys, a least-privilege bot PAT with no admin scope, and a *_ENABLED
  kill switch on every automation.'
difficulty: 🔴 Hard
draft: false
...
source_file: self-operating-website-04-the-sigils-of-trust.md
tags:
- '1001'
- oauth
- bonus_quest
...
- ci-cd
- gamified-learning
title: .github/workflows/content-factory.yml (excerpt)
---
