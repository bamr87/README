...
description: Build resilient GitHub Copilot agents with retry logic, timeouts, fallback
  strategies, and graceful error reporting that survive tool failures and API errors.
difficulty: 🔴 Hard
draft: false
...
rewards:
  ...
  - 🚨 Graceful Escalation
skill_focus: devops
source_file: agentic-safe-execution-and-error-handling.md
...
- main_quest
- hands-on
title: .github/workflows/agent-with-retries.yml
validation_criteria:
