...
description: Configure AGENTS.md, a dev container, and secrets so a GitHub Copilot
...
skill_focus: devops
source_file: agentic-dev-environment-integration.md
...
- main_quest
- hands-on
title: AGENTS.md — Agent Operating Guide
validation_criteria:
