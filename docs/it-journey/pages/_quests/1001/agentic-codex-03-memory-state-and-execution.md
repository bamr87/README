...
description: Master the three tiers of agent memory, persist state across GitHub Actions
  runs, and detect context drift before it corrupts an agent. GH-600 Domain 3.
difficulty: 🔴 Hard
draft: false
...
skill_focus: ai-ml
source_file: agentic-codex-03-memory-state-and-execution.md
tags:
- '1001'
- github-copilot
- main_quest
...
- context-management
- project-based
title: 'Tier 1 — ephemeral: a value passed step-to-step inside ONE job'
validation_criteria:
  ...
  - Explains the difference between ephemeral, session, and persistent memory in GitHub
    Actions terms
  - Writes a context-handoff JSON that survives the issue → branch → PR → Actions
    transition
---
