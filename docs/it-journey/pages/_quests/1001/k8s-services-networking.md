...
description: Master Kubernetes networking with Services, Ingress, and cluster DNS,
...
skill_focus: devops
source_file: k8s-services-networking.md
...
- hands-on
- gamified-learning
title: Deploy a backend workload to expose
validation_criteria:
