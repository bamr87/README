...
description: Design ephemeral, session, and persistent memory for GitHub Copilot agents
  using artifacts, issues, and repo files to keep context across interactions.
difficulty: 🔴 Hard
draft: false
...
skill_focus: devops
source_file: agentic-memory-strategies.md
...
- main_quest
- hands-on
title: In copilot-instructions.md — ensure the agent loads the right context
validation_criteria:
