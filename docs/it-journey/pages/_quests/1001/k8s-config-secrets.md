...
description: 'Manage Kubernetes config with ConfigMaps and Secrets: inject settings
  via env vars and volume mounts, and guard credentials beyond base64.'
difficulty: 🟡 Medium
draft: false
estimated_time: 75-90 minutes
excerpt: Manage Kubernetes configuration securely with ConfigMaps, Secrets, env vars,
  and volumes
fmContentType: quest
keywords:
  primary:
...
skill_focus: devops
source_file: k8s-config-secrets.md
...
- hands-on
- gamified-learning
title: Confirm the cluster and set a working namespace
validation_criteria:
