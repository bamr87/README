...
description: Navigate security compliance frameworks including SOC 2, GDPR, HIPAA,
  and PCI-DSS. Learn audit preparation, control implementation, and regulatory requirements.
difficulty: 🔴 Hard
draft: true
...
skill_focus:
- security
source_file: compliance-standards.md
