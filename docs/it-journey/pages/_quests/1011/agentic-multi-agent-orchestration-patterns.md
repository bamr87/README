...
description: 'Build multi-agent systems on GitHub: design fan-out, sequential chain,
  and event-driven orchestrators that dispatch sub-agent jobs and aggregate their
  results.'
difficulty: 🔴 Hard
draft: false
...
skill_focus: devops
source_file: agentic-multi-agent-orchestration-patterns.md
...
- main_quest
- hands-on
title: .github/workflows/orchestrator-fan-out.yml
validation_criteria:
