...
description: Add observability to multi-agent GitHub workflows by correlating traces
  across agents, detecting inter-agent failures, and building a unified audit log.
difficulty: 🔴 Hard
draft: false
...
rewards:
  ...
  - 📊 Multi-Agent Audit
skill_focus: devops
source_file: agentic-multi-agent-observability.md
...
- main_quest
- hands-on
title: .github/workflows/orchestrator-with-tracing.yml
validation_criteria:
