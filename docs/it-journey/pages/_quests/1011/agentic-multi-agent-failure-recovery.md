...
description: 'Build resilient multi-agent systems on GitHub: classify and detect sub-agent
  failures, retry with backoff, re-delegate, and preserve partial progress.'
difficulty: 🔴 Hard
draft: false
...
skill_focus: devops
source_file: agentic-multi-agent-failure-recovery.md
...
- main_quest
- hands-on
title: .github/workflows/orchestrator-with-recovery.yml
validation_criteria:
