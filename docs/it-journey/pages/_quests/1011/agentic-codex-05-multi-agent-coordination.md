...
description: 'Orchestrate a council of agents on GitHub Actions: fan-out and chain
  patterns, correlation-ID tracing, failure recovery, and lifecycle. GH-600 Domain
  5.'
difficulty: 🔴 Hard
draft: false
...
skill_focus: ai-ml
source_file: agentic-codex-05-multi-agent-coordination.md
tags:
- '1011'
- gh-600
- agentic-ai
...
- github-actions
- gamified-learning
title: .github/workflows/council-fanout.yml
validation_criteria:
  completion_requirements:
  - Build a fan-out orchestrator that runs two sub-agents in parallel and collects
    results
  ...
  - Can distinguish sequential, parallel, and hierarchical patterns and when each
    fits
