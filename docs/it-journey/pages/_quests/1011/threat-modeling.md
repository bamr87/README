...
description: Master threat modeling with STRIDE, data-flow diagrams, trust boundaries,
...
source_file: threat-modeling.md
...
- conceptual
- gamified-learning
title: Use VS Code with a Mermaid preview extension to diagram in plain text
validation_criteria:
