...
description: Master information security fundamentals including the CIA triad, the
  OWASP Top 10, defense in depth, secure-by-design thinking, and practical risk management.
difficulty: 🟡 Medium
draft: false
estimated_time: 90-120 minutes
excerpt: Learn foundational security concepts including the CIA triad, the OWASP Top
  10, defense in depth, and a security mindset
fmContentType: quest
keywords:
  primary:
  - '1011'
...
source_file: security-fundamentals.md
...
- conceptual
- gamified-learning
title: Install Docker Desktop (or use colima) to run the practice lab
validation_criteria:
