...
description: Tune your GitHub Copilot agent by analysing failure patterns, iterating
  on copilot-instructions.md and AGENTS.md, and measuring each change's impact.
difficulty: 🔴 Hard
draft: false
...
skill_focus: devops
source_file: agentic-behavior-tuning.md
...
- main_quest
- hands-on
title: work/gh-600/scripts/measure_agent_baseline.sh
validation_criteria:
