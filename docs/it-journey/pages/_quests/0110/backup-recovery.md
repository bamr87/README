...
description: Guard against data loss with logical and physical backups, point-in-time
...
- hands-on
- gamified-learning
title: 'Logical backup: a portable file that can recreate the database anywhere.'
validation_criteria:
