...
description: Defend the Data Keep with least-privilege grants, parameterized queries
...
source_file: database-security.md
...
- hands-on
- gamified-learning
title: '❌ VULNERABLE: user input is glued directly into the SQL string.'
validation_criteria:
