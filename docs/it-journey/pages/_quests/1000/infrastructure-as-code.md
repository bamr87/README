...
description: 'Provision cloud infrastructure declaratively with Terraform: providers
...
prerequisites:
  ...
  - Familiarity with at least one cloud provider's basic services (complete AWS Essentials
    first)
...
source_file: infrastructure-as-code.md
...
- hands-on
- gamified-learning
title: Install Terraform via the HashiCorp tap
validation_criteria:
