...
description: Choose and configure the right tools for GitHub Copilot agents, then
  enforce least-privilege permissions so your agent touches only what it needs.
difficulty: 🟡 Medium
draft: false
...
skill_focus: devops
source_file: agentic-tool-selection-and-permissions.md
...
- main_quest
- hands-on
title: work/gh-600/tool-inventories/dependency-updater-tools.yml
validation_criteria:
