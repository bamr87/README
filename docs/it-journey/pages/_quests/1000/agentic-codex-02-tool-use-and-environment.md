...
description: Equip GitHub Copilot agents with the right tools, wire MCP servers, scope
  least-privilege permissions, and bind agents to a CI environment — GH-600 Domain
  2.
difficulty: 🔴 Hard
draft: false
...
skill_focus: ai-ml
source_file: agentic-codex-02-tool-use-and-environment.md
tags:
- '1000'
- github-copilot
- main_quest
...
- tooling
- project-based
title: .github/workflows/agent.yml — least-privilege scope for a PR-opening agent
validation_criteria:
