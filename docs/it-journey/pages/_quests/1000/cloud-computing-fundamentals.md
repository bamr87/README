...
description: Learn the IaaS, PaaS, and SaaS service models, regions and availability
...
skill_focus: cloud
source_file: cloud-computing-fundamentals.md
...
- conceptual
- gamified-learning
title: Install the CLI for the provider you want to explore (pick one or more)
validation_criteria:
