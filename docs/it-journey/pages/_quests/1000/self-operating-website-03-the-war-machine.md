...
description: Stand up the autopilot proper — OODA dispatch, serverless git-ref CAS
  leasing, RICE triage, tiered pipelines, and a fifty-case end-to-end simulation that
  proves the fleet before it ever ships.
difficulty: ⚔️ Epic
draft: false
...
skill_focus: devops
source_file: self-operating-website-03-the-war-machine.md
tags:
- '1000'
- github-actions
- bonus_quest
...
- ci-cd
- gamified-learning
title: scripts/decide_core.py — the pure OODA/RICE decision functions, imported by
  decide.py.
---
