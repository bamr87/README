...
description: Embed GitHub Copilot agents into the software lifecycle with bounded
  roles, plan-then-act gates, and observable traces — GH-600 Domain 1 of The Agentic
  Codex.
difficulty: 🟡 Medium
draft: false
...
skill_focus: ai-ml
source_file: agentic-codex-01-agents-in-the-sdlc.md
tags:
- '0111'
- github-copilot
- main_quest
...
- ci-cd
- gamified-learning
title: A bounded-agent task contract (paste the body into a Copilot-assigned issue)
validation_criteria:
