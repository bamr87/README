...
description: 'Master API documentation using OpenAPI and Swagger: write a contract-first
...
skill_focus: backend
source_file: api-documentation.md
...
- hands-on
- gamified-learning
title: Install the Redocly CLI to lint and preview OpenAPI docs
validation_criteria:
