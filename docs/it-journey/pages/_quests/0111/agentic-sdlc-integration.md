...
description: 'Integrate AI agents into the SDLC: define their inputs, outputs, and
  success criteria, and learn the anti-patterns that sink autonomous workflows.'
difficulty: 🟡 Medium
draft: false
...
skill_focus: devops
source_file: agentic-sdlc-integration.md
...
- hands-on
- gamified-learning
title: Clone the starter sandbox
validation_criteria:
