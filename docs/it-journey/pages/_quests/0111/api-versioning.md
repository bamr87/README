...
description: Master API versioning strategies including URI versus header versioning,
...
- conceptual
- gamified-learning
title: GitHub versions its API via an Accept header (header versioning)
validation_criteria:
