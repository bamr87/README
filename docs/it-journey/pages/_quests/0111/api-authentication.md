...
description: Master API authentication including API keys, sessions versus tokens,
  JSON Web Tokens, OAuth2 flows, and scopes so you can secure and consume protected
  APIs.
difficulty: 🔴 Hard
draft: false
...
source_file: api-authentication.md
...
- hands-on
- gamified-learning
title: Python ships with macOS; install the JWT library for the lab
validation_criteria:
