...
description: 'Master REST constraints: resources, statelessness, the uniform interface,
...
skill_focus: backend
source_file: rest-principles.md
...
- conceptual
- gamified-learning
title: Explore GitHub's REST API - a famously well-designed example
validation_criteria:
