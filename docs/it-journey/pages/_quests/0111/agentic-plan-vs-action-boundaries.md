...
description: Configure a GitHub Copilot coding agent to produce a structured plan,
  define its JSON schema, and gate every action behind human approval.
difficulty: 🟡 Medium
draft: false
...
skill_focus: devops
source_file: agentic-plan-vs-action-boundaries.md
...
- main_quest
- hands-on
title: GitHub Copilot Agent Instructions
validation_criteria:
