...
description: 'Master Apache Spark for distributed data: RDDs, DataFrames, transformations
...
- hands-on
- gamified-learning
title: A ready-made Spark + Jupyter image, great for a Codespace or container host.
validation_criteria:
