...
description: 'Build the Analytical Citadel: model OLTP vs OLAP, design star and snowflake
...
source_file: data-warehousing.md
...
- hands-on
- gamified-learning
title: 'DuckDB needs no server and runs in any container or notebook:'
validation_criteria:
