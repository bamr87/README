...
description: 'Close the autonomy loop: a published retrospective triggers a read-only
  agent that mines merged-branch metadata and proposes a gamified quest to a separate
  repo — never mutating its source, never merging.'
difficulty: 🔴 Hard
draft: false
...
rewards:
  badges:
  - 🪄 Loop Closer — turned project history into a learnable quest without mutating
    the project
...
source_file: self-operating-website-10-the-bard-forge.md
tags:
- '1100'
- claude-code
- bonus_quest
...
- ci-cd
- gamified-learning
title: .github/workflows/bard-forge.yml (in the SOURCE repo)
---
