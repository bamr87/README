...
description: Map GitHub Copilot agents across a five-level autonomy spectrum, classify
  your task types by risk, and configure the GitHub controls that govern each level.
difficulty: 🔴 Hard
draft: false
...
skill_focus: devops
source_file: agentic-autonomy-levels-matrix.md
...
- main_quest
- hands-on
title: _data/autonomy-matrix.yml
validation_criteria:
