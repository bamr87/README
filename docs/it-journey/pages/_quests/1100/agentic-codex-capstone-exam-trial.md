...
description: 'Face the six-domain grand trial: build a complete agentic AI system
  on GitHub, prove competency across all GH-600 domains, and earn Codex Master.'
difficulty: ⚔️ Epic
draft: false
...
source_file: agentic-codex-capstone-exam-trial.md
