...
description: 'Run the full lifecycle of a GitHub-native multi-agent system: build
  a registry, monitor agent health, and provision, version, and retire agents safely.'
difficulty: ⚔️ Epic
draft: false
...
rewards:
  ...
  - 🔄 Agent Lifecycle
skill_focus: devops
source_file: agentic-multi-agent-lifecycle-management.md
...
- main_quest
- hands-on
title: _data/agents.yml — Agent Lifecycle Registry
validation_criteria:
