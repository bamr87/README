...
description: 'Build production ETL pipelines in Python: ETL vs ELT, extraction and
  loading, idempotent upserts, incremental loads, and Airflow orchestration.'
difficulty: 🔴 Hard
draft: false
estimated_time: 4-5 hours
excerpt: Build production-grade ETL pipelines with Python, covering extraction, transformation,
  idempotent loading, and Airflow orchestration
fmContentType: quest
keywords:
  primary:
  - '1100'
...
source_file: etl-pipeline-design.md
...
- hands-on
- gamified-learning
title: 'Any Codespace or container with Python works. For the Airflow chapter:'
validation_criteria:
