...
description: 'GH-600 Domain 6: classify agent actions by risk, set autonomy levels,
  enforce least-privilege guardrails, gate humans in the loop, and build an audit
  trail.'
difficulty: 🔴 Hard
draft: false
...
prerequisites:
  ...
  system_requirements:
  - A GitHub repository where you can configure CODEOWNERS, Environments, and workflow
    permissions
...
skill_focus: ai-ml
source_file: agentic-codex-06-guardrails-and-accountability.md
tags:
- '1100'
- github-copilot
- agentic-ai
...
- gh-600
- main_quest
title: .github/agent-autonomy.yml — the action → level map the gate reads
validation_criteria:
