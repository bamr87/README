...
description: Build real-time streaming pipelines with Apache Kafka. Master batch versus
  stream, event-time windowing, watermarks for late data, and exactly-once delivery.
difficulty: 🔴 Hard
draft: false
estimated_time: 4-5 hours
excerpt: Build real-time pipelines with Kafka, windowing, event-time processing, and
...
source_file: stream-processing.md
...
- hands-on
- gamified-learning
title: 'Bring up the single-broker Kafka (compose file in Chapter 2), then:'
validation_criteria:
