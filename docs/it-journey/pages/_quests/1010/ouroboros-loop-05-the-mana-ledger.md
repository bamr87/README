...
description: 'Teach your loop to survive its own appetite: mana budgets sized to real
  rate limits, date-rotated windows that sweep big sets a few items a day, cross-run
  coverage that certifies only a complete sweep, and a Watchtower digest to scry it
  all.'
difficulty: 🔴 Hard
draft: false
...
skill_focus: devops
source_file: ouroboros-loop-05-the-mana-ledger.md
tags:
- '1010'
- python
- main_quest
...
- automation
- gamified-learning
title: budget.yml — the loop's mana policy (humans edit; the planner obeys)
---
