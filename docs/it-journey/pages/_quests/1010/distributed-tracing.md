...
description: Instrument a Python service with OpenTelemetry, emit spans to Jaeger,
  propagate trace context, and debug latency across your microservices.
difficulty: 🔴 Hard
draft: false
estimated_time: 90-120 minutes
excerpt: Follow a single request across services with spans, traces, OpenTelemetry,
  and Jaeger
fmContentType: quest
keywords:
  primary:
...
skill_focus: devops
source_file: distributed-tracing.md
...
- hands-on
- gamified-learning
title: Jaeger all-in-one exposes OTLP on 4317/4318 and the UI on 16686
validation_criteria:
