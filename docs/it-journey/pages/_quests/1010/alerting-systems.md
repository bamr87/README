...
description: 'Forge production alerting with Prometheus rules and Alertmanager: routing,
...
skill_focus: devops
source_file: alerting-systems.md
...
- devops
- hands-on
title: 'Bring up the lab (compose file below), then open the UIs:'
validation_criteria:
