...
description: Build a standalone analytics digest script and schedule it with launchd
...
source_file: automate-traffic-report.md
...
- gamified-learning
- observability
title: Mondays at 09:00 — note the absolute paths and env var
validation_criteria:
