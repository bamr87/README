...
description: Define machine-verifiable success criteria, read GitHub signals to grade
  agent runs, run root-cause analysis on failures, and tune behaviour by instruction.
difficulty: 🔴 Hard
draft: false
...
skill_focus: ai-ml
source_file: agentic-codex-04-evaluation-and-tuning.md
tags:
- '1010'
- github-copilot
- main_quest
