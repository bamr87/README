...
description: Define machine-verifiable acceptance criteria for agent tasks, map them
  to GitHub signals like Actions checks and PR states, then automate completion detection.
difficulty: 🟡 Medium
draft: false
...
skill_focus: devops
source_file: agentic-success-criteria-and-signals.md
...
- main_quest
- hands-on
title: .github/workflows/check-task-completion.yml
validation_criteria:
