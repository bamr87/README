...
description: 'Deploy the ELK stack for centralized logging: Elasticsearch indexing,
  Logstash and Beats pipelines, and Kibana dashboards for distributed systems.'
difficulty: 🔴 Hard
draft: false
estimated_time: 120-150 minutes
excerpt: Build centralized logging with Elasticsearch, Logstash pipelines, Beats shippers,
...
- hands-on
- gamified-learning
title: Install Docker Desktop (or colima) and confirm Compose is available
validation_criteria:
