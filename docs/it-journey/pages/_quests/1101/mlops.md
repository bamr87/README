...
description: Take ML models from notebook to production with MLflow tracking, a model
...
- hands-on
- gamified-learning
title: Verify MLflow, then launch its tracking UI on http://localhost:5000
validation_criteria:
