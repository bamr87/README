...
description: Grant your loop write access — safely. A fixer golem repairs only issues
  the sealed evidence witnessed, keeps each edit only when a deterministic score holds-or-rises,
  aborts honestly on partial evidence, and trips a circuit breaker before looping
  forever.
difficulty: 🔴 Hard
draft: false
...
skill_focus: devops
source_file: ouroboros-loop-06-the-fixers-oath.md
tags:
- '1101'
- claude-code
- main_quest
