...
description: 'Build computer vision models in PyTorch: learn convolutions, train CNNs
...
skill_focus: ai-ml
source_file: computer-vision.md
...
- hands-on
- gamified-learning
title: Apple Silicon can accelerate with the MPS backend
validation_criteria:
