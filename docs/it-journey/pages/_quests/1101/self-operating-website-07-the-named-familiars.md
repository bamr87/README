...
description: Give every automation role a named agent — persona, tools, and hard rules
  — distinct from the skills that hold the procedure, and add a routine that reviews
  the agents and skills themselves.
difficulty: 🟡 Medium
draft: false
...
prerequisites:
  ...
  - Completed Chapter VI — The Editor's Eye, and defeated the Self-Retrigger Loop
    boss
...
skill_focus: devops
source_file: self-operating-website-07-the-named-familiars.md
tags:
- '1101'
- claude-code
- bonus_quest
...
- ci-cd
- gamified-learning
title: .claude/agents/content-reviewer.md  (frontmatter shown)
---
...
**Campaign hub:** [[Epic Quest: The Self-Operating Website]] **Previous:** [[The Editor's Eye]] **Next:** [[The Cartographer]] **Obsidian docs:** [[Obsidian Knowledge Graph and Wiki Links]]
