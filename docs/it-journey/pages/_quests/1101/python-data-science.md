...
description: 'Forge the Data Artisan''s Toolkit: master NumPy vectorization, Pandas
  DataFrames, exploratory analysis, and Matplotlib charts, then train a scikit-learn
  model.'
difficulty: 🟡 Medium
draft: false
...
source_file: python-data-science.md
...
- hands-on
- gamified-learning
title: Google Colab and most data science images ship these preinstalled.
validation_criteria:
