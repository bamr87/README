...
description: The canonical lexicon of the IT-Journey realm — every fantasy term decoded
  into the technology behind it, from spells and scripts to golems and pipelines.
difficulty: 🟢 Easy
draft: false
estimated_time: Variable
excerpt: The realm's shared dictionary — fantasy on one side, real technology on the
  other.
fmContentType: codex
keywords:
  primary:
