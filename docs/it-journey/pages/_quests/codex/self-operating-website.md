...
description: Forge a Jekyll site that runs itself — a robot drafts content, files
  its own bugs, opens and reviews pull requests, and journals every session, while
  a human still holds the merge button. A ten-chapter capstone campaign.
difficulty: ⚔️ Epic
draft: false
estimated_time: 40-60 hours
excerpt: Build a self-operating CMS — autonomous content, CI gates, an AI fleet, and
  a human merge button — reverse-engineered from a real 40-branch build.
fmContentType: quest
keywords:
  primary:
  - epic_quest
...
source_file: self-operating-website.md
tags:
- '1111'
- github-actions
- epic_quest
...
- gamified-learning
- project-based
title: '1. On a machine logged into Claude, mint a Code OAuth token:'
validation_criteria:
  completion_requirements:
  - All ten chapters completed and their boss fights survived
  - A site that drafts, reviews, and proposes its own changes behind a human merge
    button
  knowledge_checks:
