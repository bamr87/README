...
description: 'The capstone: assemble walk, fix, and merge into one self-perfecting
  engine. Auto-merge that waits for every check except its own, a smuggle guard that
  keeps content PRs content-only, and a full turn of the loop with zero human hands
  on the fix.'
difficulty: ⚔️ Epic
draft: false
...
skill_focus: devops
source_file: ouroboros-loop-07-weaving-the-whole.md
tags:
- '1110'
- github-actions
- main_quest
...
- ai-agents
- gamified-learning
title: .github/workflows/auto-merge.yml
---
