...
description: Master API gateway patterns - routing, authentication, rate limiting,
...
skill_focus: backend
source_file: api-gateway-patterns.md
...
- hands-on
- gamified-learning
title: Run NGINX with a custom config you will write below
validation_criteria:
