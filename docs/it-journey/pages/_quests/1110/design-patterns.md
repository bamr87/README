...
description: Implement Factory, Strategy, Observer, Adapter, and Decorator, master
...
source_file: design-patterns.md
...
- hands-on
- gamified-learning
title: Python ships with modern macOS, but a Homebrew install is cleaner
validation_criteria:
