...
description: 'Learn event-driven architecture: events as facts, pub/sub messaging,
  event sourcing, CQRS, and the eventual consistency that decouples systems.'
difficulty: 🔴 Hard
draft: false
estimated_time: 4-5 hours
excerpt: Design decoupled systems with events, pub/sub, event sourcing, CQRS, and
...
skill_focus: backend
source_file: event-driven-design.md
...
- conceptual
- gamified-learning
title: Redpanda is a lightweight, Kafka-compatible broker for local use
validation_criteria:
