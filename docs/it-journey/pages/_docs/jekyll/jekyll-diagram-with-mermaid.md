...
description: Complete guide to adding Mermaid diagrams to Jekyll sites with zero configuration.
  Create flowcharts, sequence diagrams, Gantt charts, and more with automatic detection
  and rendering.
difficulty: beginner
estimated_time: 10 minutes
excerpt: Add beautiful Mermaid diagrams to your Jekyll site without any configuration.
  Automatic detection renders flowcharts, sequence diagrams, and more from simple
...
mermaid: true
source_file: jekyll-diagram-with-mermaid.md
subcategory: jekyll
tags:
- mermaid
- jekyll
...
- auto-detection
- zero-configuration
title: No flag needed! Auto-detection handles this
---
