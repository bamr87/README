---
date: 2024-05-07 23:07:39+00:00
date_retrieved: 2024-05-02 16:05:28
description: The tables below list the available settings for Jekyll, and the various
  options (specified in the configuration file) and flags (specified on the command-line)
  that control them.
lastmod: 2024-05-02 22:07:45.703000+00:00
source_file: jekyll-config.md
