...
description: How the oneline prose rule is enforced everywhere — CI backstop, hub
  auto-fix, the shared AI runner, a Claude Code hook, and a pre-commit hook.
source_file: prose-oneline-universal.md
tags:
- ci
- prose
- markdown
