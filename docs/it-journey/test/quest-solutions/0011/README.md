...
title: Level 0011 — Quest Solutions
---
...
When completing a Level 0011 quest with hands-on validation:

```bash
# 1. Create the solution directory
mkdir -p test/quest-solutions/0011/<quest-slug>/{scripts,reports}

# 2. Copy the templates
cp test/quest-solutions/_shared/templates/quest-solution-readme-template.md \
   test/quest-solutions/0011/<quest-slug>/README.md
cp test/quest-solutions/_shared/templates/answer-key-template.md \
   test/quest-solutions/0011/<quest-slug>/answer-key.md
