...
session:
  average_score: 75.0
  engine_cost_usd: 3.0902
  evidence: walk-evidence.json
  note: Machine evidence was pre-computed and sealed by the workflow's deterministic
    execute-engine step (agentic_validate.py --mode execute). This agent consumed
    walk-evidence.json / walk-evidence.md as-is and did NOT re-run the engine or edit
    any quest content.
  plan: walk-plan.json
  verdict_counts:
    fail: 1
    pass: 2
    warn: 2
  window: 1 of 3 (quests 1–5 of 13 in the level)
source_file: 2026-07-21-system-engineer-0101.md
theme: CI/CD & DevOps
tier: Adventurer
