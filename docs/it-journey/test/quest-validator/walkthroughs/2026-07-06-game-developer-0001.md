...
session:
  engine_average: 65.0
  engine_cost_usd: 3.8787
  engine_counts: 1 pass · 2 warn · 2 fail (1 of the fails is an engine/max-turns abort,
  ...
  note: Report composed from pre-sealed execute-engine evidence; the walker did not
    re-run the engine.
  window: 3 of 6 (offset 15, 5 of 26 quests)
source_file: 2026-07-06-game-developer-0001.md
