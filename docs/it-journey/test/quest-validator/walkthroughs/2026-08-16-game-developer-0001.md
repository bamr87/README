...
session:
  cost_usd: 2.8965
  engine_average: 45.0
  engine_counts: 0 pass · 1 warn · 4 fail (2 of which errored with no score)
  note: Sealed execute-mode evidence consumed as-is from walk-evidence.json / walk-evidence.md
    (workflow-minted). No engine re-run, no content edits.
