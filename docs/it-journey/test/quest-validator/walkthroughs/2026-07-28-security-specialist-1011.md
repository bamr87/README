...
session:
  average_score: 75.0
  engine_cost_usd: 3.5301
  evidence: sealed by quest-perfection workflow (agentic_validate.py --mode execute)
  planner: walkthrough_plan.py --window
  verdict_split: 3 pass · 0 warn · 2 fail
  window: 1 of 3 (5 of 12 quests in the level)
source_file: 2026-07-28-security-specialist-1011.md
