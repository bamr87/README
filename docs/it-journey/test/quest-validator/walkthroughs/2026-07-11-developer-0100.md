...
quests_evaluated: 3
quests_scored: 1
session: Windowed slice (window 1 of 2, 5 of 8 quests). Engine evidence sealed by
  the workflow. Only 1 of 5 quests received a full machine-scored verdict (frontend-docker,
  30% fail); 2 quests errored on sandbox limits (Docker/network denied → max_turns)
  and 2 were never reached (auth truncation). Coverage is partial — see §7.
source_file: 2026-07-11-developer-0100.md
theme: Frontend & Containers
tier: Adventurer
title: 2026 07 11 Developer 0100
---
## 🎯 Session Summary
