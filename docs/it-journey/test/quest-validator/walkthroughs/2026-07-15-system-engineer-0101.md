...
quest_count: 5
session: 'Window 1 of 3 (5 of 13 quests) of the System Engineer Adventurer slice,
  walked end-to-end from workflow-sealed execute-mode evidence (walk-evidence.json,
  avg 60.8%, ~$2.71). The CI/CD spine (CI/CD Fundamentals → GitHub Actions Basics
  → The Warden''s Gate) holds together as a coherent learning path; two off-spine
  quests block: the Docker quest is an unfilled template, and the LaTeX CV quest ships
  without its core cv.tex artifact and with a document-wide doubled-backslash defect.
  Evidence is machine-sealed; the linked-journey reasoning is mine.'
source_file: 2026-07-15-system-engineer-0101.md
theme: CI/CD & DevOps
tier: Adventurer
