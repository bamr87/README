...
session:
  ...
  errored: 1
  note: One quest (PRD Codex) produced no content verdict — the execute engine hit
    its 40-turn ceiling before scoring. That is a harness/timeout outcome, not a quality
