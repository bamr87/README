...
session:
  ...
  note: One quest (Azure Ascension) has NO machine score — the execute engine exited
    1 after hitting max_turns (40). Treated as no-evidence/tooling error, not a content
    failure. Reasoned about statically only.
