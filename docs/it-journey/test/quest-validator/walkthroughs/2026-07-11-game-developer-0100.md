...
session:
  ...
  note: Two of the five quests (both Docker main quests) errored out in the execute
    engine (max_turns) and carry NO machine-checked content verdict — they were only
    reasoned about statically. Coverage is therefore partial; see §7.
  scored: 3
