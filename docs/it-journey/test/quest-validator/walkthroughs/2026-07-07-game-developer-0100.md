...
session:
  ...
  notes: Quest 1 (container-fundamentals) errored in the engine (child claude process
    hit max_turns=40 with two Bash permission denials on curl/wget) and carries NO
    machine score — it is reasoned about statically only and never counted as passed/failed.
    The other 4 quests have real sandboxed command evidence.
  window: 1 of 2 (5 of 8 quests)
source_file: 2026-07-07-game-developer-0100.md
