...
session:
  ...
  engine_counts:
    ...
    pass: 2
    warn: 0
  evidence_source: walk-evidence.json / walk-evidence.md (sealed by the workflow)
  slice_source: walk-plan.json (date-rotated, windowed)
  window: 2 of 3 (quests 11–15 of 15 in level 1100)
