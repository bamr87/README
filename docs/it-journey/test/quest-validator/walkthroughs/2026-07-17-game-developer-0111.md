...
session:
  engine_average: 66.2
  engine_cost_usd: 3.8497
  engine_counts: 2 pass · 1 warn · 2 fail
  evidence: walk-evidence.json + walk-evidence.md (sealed by workflow, execute mode)
  planner: walk-plan.json (windowed, window 1 of 2, 5 of 10 quests)
  walker: quest-walker (read-only; no content mutated)
