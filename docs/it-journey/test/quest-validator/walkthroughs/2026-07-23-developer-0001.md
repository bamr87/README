...
session:
  ...
  note: Evidence pre-computed and sealed by the workflow; the walker consumed it read-only
    and reasoned about the linked journey by reading each quest source.
  planner_offset: 10
