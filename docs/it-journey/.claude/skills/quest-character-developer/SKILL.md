---
description: Play or repair IT-Journey quests as the 💻 Software Developer character
  path — persona, voice, per-level exercise checkpoints, and friction lens for developer/<level>
  slices. Load (Read this file) whenever walk-plan.json or a fix slice names character
  "developer", when walking quests as this class, or when judging whether a quest
