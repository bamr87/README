---
description: Run one incremental pass of the IT-Journey content-improvement loop.
  Use when asked to curate/improve content, run the daily CMS loop, work the .cms
  worklist, fix frontmatter/SEO/freshness across pages, or group content improvements
  into a PR.
name: cms-curator
source_file: SKILL.md
title: 'if any pages/_quests/** changed:'
---
