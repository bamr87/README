---
description: Run ONE pass of the IT-Journey frontend canary — crawl it-journey.dev
  for UI/UX/a11y/theme defects, classify theme-vs-content, dedup, and file the theme
  issues upstream to bamr87/zer0-mistakes. Use when asked to test the it-journey.dev
  frontend, scout for theme bugs, run the frontend canary, or file theme issues upstream.
  Drives the theme-scout agent.
name: theme-scout
source_file: SKILL.md
title: Theme Scout — one frontend-canary pass
---
