...
description: 'Author IT-Journey notes: dated dev notes, cheatsheets, code snippets,
  and working scratch pads at /notes/'
lastmod: 2026-05-24 00:00:00+00:00
source_file: notes.instructions.md
title: Notes Collection — `pages/_notes/**`
---
