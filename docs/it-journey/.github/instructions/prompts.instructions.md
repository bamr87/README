...
description: Author and refine prompt files (.prompt.md) following the IT-Journey
  prompt-engineering and Kaizen schema
lastmod: 2026-05-18 12:00:00+00:00
source_file: prompts.instructions.md
title: Prompt Engineering — `.prompt.md`
---
