...
description: Generate IT education article outlines with learning objectives, audience
  definition, and Kaizen-driven structure
inputs:
- description: Main subject of the article (e.g., 'Docker networking', 'Git branching
    strategies')
  name: topic
  required: true
...
source_file: draft-article.prompt.md
title: 📝 Draft Article Outline Protocol
