...
description: Review changes, run tests, update documentation, and publish IT-Journey
  Jekyll site via PR to gh-pages branch
mode: agent
source_file: commit-publish.prompt.md
title: Commit & Publish Workflow for IT-Journey Jekyll Site
---
