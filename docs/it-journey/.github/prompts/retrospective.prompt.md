...
description: Review an AI conversation/PR and fold lessons back into instructions
  and prompts with citations
lastmod: 2026-05-18 12:00:00+00:00
mode: agent
source_file: retrospective.prompt.md
title: '🔁 Retrospective: Close the AI Learning Loop'
---
