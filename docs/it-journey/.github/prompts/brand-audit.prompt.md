...
description: 'Audit posts for brand/voice drift: run the CMS brand check and report
  banned terms, spellings, emoji, structure, and formality issues by section'
lastmod: 2026-06-21 00:00:00+00:00
mode: agent
source_file: brand-audit.prompt.md
title: Brand Audit
---
# Brand Audit
