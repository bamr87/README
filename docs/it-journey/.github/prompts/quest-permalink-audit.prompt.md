...
description: Audit and repair quest permalinks across pages/_quests/ — validates the
  canonical /quests/XXXX/[side-quests/]slug/ hierarchy, identifies violations, and
  optionally applies fixes.
lastmod: 2026-05-23 00:00:00+00:00
mode: agent
source_file: quest-permalink-audit.prompt.md
title: Quest Permalink Audit
---
