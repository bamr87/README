...
description: Build applications powered by GitHub Copilot using the Copilot SDK. Use
  ...
  MCP servers, BYOK providers, session persistence, custom agents, skills, and deployment
  patterns. Requires GitHub Copilot CLI installed and a GitHub Copilot subscription
  (unless using BYOK).
name: copilot-sdk
