...
description: 'Create AI agents and workflows using Microsoft Agent Framework SDK.
  ...
  DO NOT USE FOR: deploying agents (use agent/deploy), evaluating agents (use agent/evaluate),
  Azure AI Foundry agents without Agent Framework SDK.'
name: agent-framework
source_file: SKILL.md
title: Create Agent with Microsoft Agent Framework
---
