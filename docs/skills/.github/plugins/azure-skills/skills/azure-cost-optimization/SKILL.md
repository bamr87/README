...
description: 'Identify and quantify cost savings across Azure subscriptions by analyzing
  ...
  find cost savings, generate cost optimization report, find orphaned resources, rightsize
  VMs,

  cost analysis, reduce waste, Azure spending analysis, find unused resources, optimize
  Redis
...
title: Azure Cost Optimization Skill
---
