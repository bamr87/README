...
description: 'Pre-deployment validation checkpoint. Run deep checks to ensure your
  ...
  configuration, check if ready to deploy, validate azure.yaml, validate Bicep, test
  before deploying, troubleshoot deployment errors.

  DO NOT USE FOR: creating or building apps (use azure-prepare), executing deployments
  (use azure-deploy).'
name: azure-validate
