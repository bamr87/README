...
description: 'Use for Azure AI: Search, Speech, OpenAI, Document Intelligence. Helps
  ...
  speech-to-text, text-to-speech, transcribe, OCR, convert text to speech. DO NOT
  USE FOR: Function apps/Functions (use azure-functions), databases (azure-postgres/azure-kusto),
