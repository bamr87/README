...
description: 'Azure AI Search SDK for .NET (Azure.Search.Documents). Use for building
  ...
  SearchIndexerClient (indexers, skillsets). Triggers: "Azure Search .NET", "SearchClient",
  "SearchIndexClient", "vector search C#", "semantic search .NET", "hybrid search",
...
title: Azure.Search.Documents (.NET)
---
