...
description: 'Azure API Center SDK for .NET. Centralized API inventory management
  ...
  "API Center", "ApiCenterService", "ApiCenterWorkspace", "ApiCenterApi", "API inventory",
  "API governance", "API versioning", "API catalog", "API discovery".

  '
name: azure-mgmt-apicenter-dotnet
package: Azure.ResourceManager.ApiCenter
source_file: SKILL.md
title: Azure.ResourceManager.ApiCenter (.NET)
---
