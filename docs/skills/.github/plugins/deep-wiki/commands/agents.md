---
description: Generate AGENTS.md files for pertinent repository folders — only where
  missing. Provides coding agents with build commands, testing instructions, code
  style, project structure, and boundaries.
source_file: agents.md
title: 'Deep Wiki: Generate AGENTS.md Files'
---
