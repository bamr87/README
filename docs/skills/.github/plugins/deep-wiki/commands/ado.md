---
description: Generate a Node.js build script that converts the VitePress wiki to Azure
  DevOps Wiki-compatible markdown in dist/ado-wiki/. Transforms Mermaid syntax, strips
  front matter, fixes links.
source_file: ado.md
title: 'Deep Wiki: Azure DevOps Wiki Export'
---
