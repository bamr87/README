---
description: Generate a fast, concise wiki for the current repository — optimized
  for speed, minimal tool calls, and avoiding rate limits. Produces a complete VitePress
  site without running builds.
source_file: crisp.md
title: 'Deep Wiki: Crisp (Fast Wiki Generation)'
---
