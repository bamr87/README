---
description: Generate four audience-tailored onboarding guides in an onboarding/ folder
  — Contributor, Staff Engineer, Executive, and Product Manager
source_file: onboard.md
title: 'Deep Wiki: Onboarding Guide Generation'
---
