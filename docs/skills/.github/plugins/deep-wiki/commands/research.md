---
description: Conduct multi-turn deep research on a specific topic — traces actual
  code paths with zero tolerance for shallow analysis
source_file: research.md
title: 'Deep Wiki: Deep Research'
---
