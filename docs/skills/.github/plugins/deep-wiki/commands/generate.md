---
description: Generate a complete wiki for the current repository — catalogue + all
  pages + onboarding guides + VitePress site with dark-mode Mermaid diagrams
source_file: generate.md
title: 'Deep Wiki: Full Generation'
---
