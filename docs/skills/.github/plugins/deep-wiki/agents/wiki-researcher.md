---
description: Expert code analyst conducting systematic deep research with zero tolerance
  for shallow analysis — traces actual code paths and grounds every claim in evidence
model: sonnet
name: wiki-researcher
source_file: wiki-researcher.md
