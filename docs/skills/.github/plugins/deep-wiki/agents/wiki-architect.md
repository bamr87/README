---
description: Technical documentation architect that analyzes repositories and generates
  structured wiki catalogues with onboarding guides
model: sonnet
name: wiki-architect
source_file: wiki-architect.md
