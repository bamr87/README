---
description: Scaffold a new full-stack Azure AI Foundry application with React frontend,
  FastAPI backend, and azd infrastructure
mode: agent
source_file: scaffold-foundry-app.prompt.md
title: Scaffold Foundry App
---
