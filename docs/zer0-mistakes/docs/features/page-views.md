...
- Jekyll
- Liquid
description: How the theme tracks a page view and renders the count, with a local-first
  provider and an optional counter endpoint
lastmod: 2026-08-23
source_file: page-views.md
tags:
- features
- analytics
- privacy
