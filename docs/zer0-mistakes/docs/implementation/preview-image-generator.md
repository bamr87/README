...
description: Generate AI-powered preview images for Jekyll posts — Claude analyzes
  the article and reviews the result; OpenAI, xAI, Stability, Gemini, or a local template
  renders it.
feature_id: ZER0-004
