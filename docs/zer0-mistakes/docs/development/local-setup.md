...
description: Set up a local Zer0-Mistakes development environment with Docker or a
  native Ruby toolchain, then run the dev server and validate your changes.
