---
source_file: v0.3.0-release-notes.md
title: 'Release Notes: Zer0-Mistakes v0.3.0'
---
...
```html
<div class="mermaid">
  sequenceDiagram Alice->>John: Hello John! John-->>Alice: Hello Alice!
</div>
```
...
```html
<div class="mermaid">
  classDiagram Animal <|-- Duck Animal : +int age Animal: +isMammal()
</div>
```
