...
description: 'Styling and UI keys in _config.yml for Zer0-Mistakes: what each controls,
  example values, and why Jekyll must be restarted after editing config.'
