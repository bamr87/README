...
description: 'The layered installer architecture: bootstrap script, CLI dispatcher,
  focused library modules, declarative YAML profiles, and pluggable deploy targets.'
