...
description: Overview of the modular, profile-driven Zer0-Mistakes installer CLI,
  the classic install.sh one-liner, and how to choose the right install path.
