...
date: '2025-11-24'
purpose: Complete technical blueprint to rebuild zer0-mistakes Jekyll theme from scratch
  using only this document as source of truth
repository: https://github.com/bamr87/zer0-mistakes
source_file: seed.prompt.md
title: '🚀 Zer0-Mistakes: Complete Jekyll Theme Blueprint'
version: 0.6.0
---
