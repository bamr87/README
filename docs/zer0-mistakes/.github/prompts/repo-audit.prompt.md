...
description: 'Routinely review the zer0-mistakes repository AND triage all open GitHub
  issues, filing tactical tasks into _data/backlog.yml. Audits test coverage & quality,
  documentation freshness, roadmap delivery, and folds/consolidates open issues (source:
  issue, links.issue adoption), then opens a single PR. Use for the weekly AUDIT+INTAKE
  routine or whenever asked to ''review the repo and triage issues''.'
lastmod: 2026-05-31 12:00:00+00:00
mode: agent
source_file: repo-audit.prompt.md
title: Repo Audit — fill the backlog
tools:
- run_in_terminal
- read_file
