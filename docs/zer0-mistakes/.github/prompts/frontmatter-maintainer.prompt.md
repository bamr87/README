---
agent: agent
description: CLI-style front matter maintenance for YAML front matter across repo
  content
mode: agent
source_file: frontmatter-maintainer.prompt.md
title: Front Matter Maintainer (CLI) — Zer0-Mistakes
tools:
- run_in_terminal
- read_file
- apply_patch
