...
description: Complete technical blueprint to rebuild zer0-mistakes Jekyll theme from
  scratch using only this document as source of truth
lastmod: 2026-05-18 12:00:00+00:00
mode: agent
source_file: seed.prompt.md
title: Zer0-Mistakes — Rebuild Blueprint (Seed)
---
