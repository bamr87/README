...
description: Add a new Obsidian wiki-link, embed, or callout syntax to all three rendering
  paths (Liquid wiki-index, JS resolver, optional Ruby plugin), update tests, and
  document it — without breaking the GitHub Pages deployment.
lastmod: 2026-05-18 12:00:00+00:00
mode: agent
source_file: obsidian-add-syntax.prompt.md
title: Add an Obsidian Syntax Feature
---
