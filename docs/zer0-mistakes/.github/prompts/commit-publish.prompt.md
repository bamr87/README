...
description: 'Run the full release pipeline for the jekyll-theme-zer0 gem: analyze
  changes → validate build → update CHANGELOG/version → commit → tag → publish to
  RubyGems → verify. Use when asked to commit, push, release, publish, cut a version,
  or ship a new gem.'
lastmod: 2026-05-30 23:00:00+00:00
mode: agent
source_file: commit-publish.prompt.md
title: Release Pipeline — `jekyll-theme-zer0`
tools:
- run_in_terminal
- read_file
