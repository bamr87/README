...
description: Write a blog post in the voice of an AI author persona defined in _data/authors.yml
  (e.g. Cassandra, Vega).
lastmod: 2026-06-22 00:00:00+00:00
mode: agent
source_file: ai-author.prompt.md
title: AI Author — Persona Article Template
---
