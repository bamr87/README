...
description: Architecture, conventions, and safety contracts for the modular installer
  (CLI dispatcher, library modules, declarative profiles, deploy plugins, AI integration).
  Read this when touching anything under scripts/lib/install/, scripts/bin/install,
  install.sh, or installer-related templates.
lastmod: 2026-05-18 12:00:00+00:00
source_file: install.instructions.md
title: Installer Development Instructions
---
