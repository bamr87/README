...
At {{ site.title }}, we are committed to protecting your privacy and being transparent about how we collect, use, and share information about you. This Privacy Policy explains our practices regarding personal information when you visit our website.
...
- Clicks on downloads and external links
...
- Comment on blog posts or content
...
**Data Processing:** PostHog processes this data to provide analytics insights. You can learn more about PostHog's data practices at [posthog.com/privacy](https://posthog.com/privacy).

**Your Control:** You can opt out of analytics tracking at any time using our cookie preferences (see "Your Choices" section below).
...
- Is never enabled without your explicit consent
...
4. **Do Not Track**: We respect the Do Not Track (DNT) browser setting
...
- **Encryption**: Data transmitted to our site is encrypted using HTTPS
...
- **Analytics data**: Up to 24 months (configurable in PostHog)
- **Contact form data**: Until resolved plus reasonable follow-up period
- **Cookie preferences**: 12 months or until you clear browser data
