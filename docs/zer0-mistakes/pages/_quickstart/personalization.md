...
- Documentation
- Quick Start
description: Customize your Jekyll site with interactive forms. Configure site identity,
  branding, analytics, social links, and generate your complete _config.yml.
draft: false
keywords:
  primary:
...
sidebar:
  nav: quickstart
source_file: personalization.md
tags:
- jekyll
- configuration
- personalization
