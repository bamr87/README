...
description: The Site Builder walks you through nine steps, from prerequisites to
  a running zer0-mistakes site, with Claude or Grok — your own token — checking your
  machine, writing files and starting Docker.
draft: false
keywords:
- jekyll site builder
- guided jekyll setup
