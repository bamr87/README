...
<div class="tab-content pt-4" id="themeTabContent">
  ...
  <div class="tab-pane fade" id="pane-skin-editor" role="tabpanel">
    ...
    <div class="alert alert-info mt-4 small">
      ...
      <strong>Tip:</strong> Click any swatch to copy its hex code. Use <strong>Save Custom</strong> to persist your skin in localStorage.
  ...
  <div class="tab-pane fade" id="pane-palette" role="tabpanel">
    ...
    <div class="row g-3 mb-4 align-items-end">
      <div class="col-auto">
        <label class="form-label small fw-semibold" for="palette-base-color">Base Color</label>
      ...
      <div class="col-auto">
        <label class="form-label small fw-semibold" for="palette-harmony">Harmony</label>
      ...
      <div class="col-auto">
        ...
        <button class="btn btn-sm btn-primary" id="palette-apply" title="Apply palette to live preview">
          <i class="bi bi-arrow-right-circle me-1"></i>Apply to Live Preview
        </button>
      </div>
    </div>
  ...
  <div class="tab-pane fade" id="pane-colors" role="tabpanel">
    ...
    <p class="text-body-secondary mb-3">Edit theme color values below. Changes are reflected in the Export tab.</p>
