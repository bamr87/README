...
description: Learn about Zer0-Mistakes — a Docker-first Jekyll theme with Bootstrap
  5, AI-powered installation, automated releases, and privacy-compliant analytics.
draft: false
excerpt: The story, stack, and quick-start guide for the Zer0-Mistakes Jekyll theme
  — Docker-first, Bootstrap 5, GitHub Pages compatible.
...
- docker
- getting-started
title: 1. AI-powered one-line install (creates a new site in ./my-site)
---
{{ site.description }}
