...
description: Serve your Jekyll site from a 14-year-old desktop with Docker, LiveReload
  over the LAN, and a one-command sync loop — a free staging box for theme work.
draft: false
estimated_reading_time: 8 min
featured: false
lastmod: 2026-08-15 12:00:00+00:00
layout: article
source_file: 2026-08-15-jekyll-preview-server-from-an-old-pc.md
tags:
- jekyll
- docker
- homelab
