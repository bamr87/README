...
description: A tutorial example post showing practical HTML patterns for forms that
  are easier to use and test.
draft: false
...
source_file: 2026-04-28-accessible-form-patterns.md
tags:
- accessibility
- forms
- html
