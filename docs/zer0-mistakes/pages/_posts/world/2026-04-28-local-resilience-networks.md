...
description: A world example post exploring practical community coordination, shared
  resources, and local response planning.
draft: false
...
1. Choose a scenario, such as a power outage or flood warning.
2. Ask each group what information they would need first.
3. Identify who can provide that information.
4. Note resource gaps.
