...
description: Set up a Docker-based Jekyll environment with live reload, gem caching,
  and the dual-config pattern for consistent builds on macOS, Windows, and Linux.
draft: true
