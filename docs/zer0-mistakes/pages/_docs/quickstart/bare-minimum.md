...
- docs
- quickstart
description: Start a working GitHub Pages site that uses zer0-mistakes as a remote
  theme with just three files — _config.yml, Gemfile, and index.md.
difficulty: beginner
