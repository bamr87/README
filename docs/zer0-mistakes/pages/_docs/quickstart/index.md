...
- docs
- quickstart
description: Pick the fastest path to a live Zer0-Mistakes site — a three-file remote-theme
  starter, the fork-and-deploy GitHub Pages workflow, or a step-by-step series.
difficulty: beginner
