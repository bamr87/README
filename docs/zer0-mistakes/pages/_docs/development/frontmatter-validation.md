...
- docs
- development
description: Schema-driven frontmatter validation that catches missing required fields,
  bad date formats, and unknown layouts before Jekyll builds.
...
sidebar:
  nav: docs
source_file: frontmatter-validation.md
tags:
- validation
- frontmatter
- content
