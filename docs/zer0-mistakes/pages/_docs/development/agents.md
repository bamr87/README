...
- docs
- development
description: How the repository-root AGENTS.md file gives AI coding agents — Copilot,
  Codex, Cursor, Aider, Jules, Continue, and Claude Code — a single source of truth.
