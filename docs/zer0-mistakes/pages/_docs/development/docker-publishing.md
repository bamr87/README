...
- docs
- development
description: Publish the jekyll-theme-zer0 gem from a clean Docker container, mirroring
  the CI release path for reproducible builds without touching host Ruby.
difficulty: advanced
...
sidebar:
  nav: docs
source_file: docker-publishing.md
tags:
- docker
- release
- ci-cd
