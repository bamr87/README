...
- docs
- features
description: Admin-style layout and dashboard partials for surfacing site configuration,
  build info, and feature flags in a single place.
...
sidebar:
  nav: docs
source_file: admin-dashboard.md
tags:
- admin
- dashboard
- ui
