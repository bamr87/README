...
- docs
- features
date: 2026-07-23 00:00:00+00:00
description: Build the left sidebar automatically from your page URLs — a collapsible
  tree grouped by section — with no curated _data/navigation file.
keywords:
- sidebar navigation
- auto navigation
- page tree
...
sidebar:
  ...
  nav: pages
  title: All docs
source_file: sidebar-page-tree.md
tags:
- navigation
- sidebar
- liquid
title: 'Page-tree sidebar (`nav: pages`)'
---
