...
- docs
- features
description: Bootstrap 5.3.3 CSS/JS and Bootstrap Icons are committed under assets/vendor/
  for GitHub Pages safety and offline development. How to use and refresh them.
...
sidebar:
  nav: docs
source_file: vendored-assets.md
tags:
- bootstrap
- assets
- vendor
