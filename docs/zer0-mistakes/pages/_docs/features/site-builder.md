...
- docs
- features
date: 2026-09-05 00:00:00+00:00
description: The Site Builder reference covers its nine steps, the provider picker
  and bring-your-own token, guided and open sessions, the files it generates, the
  AI tools, the dev-proxy routes behind them, and the safety boundaries.
