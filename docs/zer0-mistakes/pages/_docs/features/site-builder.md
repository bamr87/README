...
description: The Site Builder reference covers its nine steps, the files it generates,
  the Claude tools, the dev-proxy routes behind them, and the safety boundaries.
