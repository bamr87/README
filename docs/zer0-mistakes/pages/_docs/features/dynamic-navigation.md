...
- docs
- features
description: Zero-config navigation that auto-populates the navbar from Jekyll collections
  when no _data/navigation entry exists, so brand-new sites get a usable menu.
difficulty: beginner
...
sidebar:
  nav: docs
source_file: dynamic-navigation.md
tags:
- navigation
- ui
- zero-config
