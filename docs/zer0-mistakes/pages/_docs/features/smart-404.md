...
- docs
- features
description: How the zer0-mistakes 404 page auto-detects whether the site is a fork,
  remote-theme consumer, or full clone and guides visitors back to a working entry
  point.
difficulty: beginner
