...
- docs
- features
description: A WCAG 2.1 Level AA skip link lets keyboard users bypass the navigation
  and jump straight to the main content area on every page of the theme.
difficulty: beginner
estimated_reading_time: 5 minutes
lastmod: 2026-08-26 00:00:00+00:00
layout: default
permalink: /docs/features/skip-to-content/
preview: /images/previews/skip-to-content-accessibility-link.png
sidebar:
  nav: docs
source_file: skip-to-content.md
tags:
- accessibility
- wcag
- keyboard
