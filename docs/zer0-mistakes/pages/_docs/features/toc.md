...
- docs
- features
description: Automatic table of contents built from a page's h1-h3 headings, with
  a positional scroll spy that bolds the section being read and smooth anchor scrolling.
difficulty: beginner
