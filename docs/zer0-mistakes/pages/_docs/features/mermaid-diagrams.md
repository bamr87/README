...
description: 'Add Mermaid diagrams to any Jekyll site: flowcharts, sequence diagrams,
  class diagrams and more, with a zoom toolbar and automatic dark-mode theming.'
difficulty: beginner
...
sidebar:
  nav: docs
source_file: mermaid-diagrams.md
tags:
- mermaid
- diagrams
- jekyll
