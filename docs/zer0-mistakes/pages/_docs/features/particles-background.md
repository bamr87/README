...
- docs
- features
description: Interactive particle animation background using particles.js for visual
  enhancement on landing and hero sections.
...
sidebar:
  nav: docs
source_file: particles-background.md
tags:
- ui
- animation
- visual
