...
- docs
- features
description: Publish recipes as structured front matter — ingredients, ratios, timings
  — rendered with serving scaling, US↔metric conversion, and baker's percentages.
difficulty: beginner
...
sidebar:
  nav: docs
source_file: cookbook-collection.md
tags:
- recipes
- cookbook
- collections
