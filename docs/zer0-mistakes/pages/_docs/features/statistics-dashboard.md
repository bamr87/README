...
- docs
- features
description: Content statistics dashboard layout with metrics visualization for posts,
  categories, and tags across the site.
difficulty: intermediate
estimated_reading_time: 4 minutes
lastmod: 2026-06-30 00:00:00+00:00
layout: default
permalink: /docs/features/statistics-dashboard/
preview: /images/previews/statistics-dashboard-feature.png
sidebar:
  nav: docs
source_file: statistics-dashboard.md
tags:
- dashboard
- statistics
- metrics
