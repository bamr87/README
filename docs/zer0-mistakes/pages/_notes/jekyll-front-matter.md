...
description: Complete reference for Jekyll front matter variables used in the Zer0-Mistakes
  theme with examples and best practices
difficulty: beginner
lastmod: 2026-01-31 10:00:00+00:00
layout: note
permalink: /notes/jekyll-front-matter/
source_file: jekyll-front-matter.md
tags:
- jekyll
- yaml
- front-matter
- documentation
title: Article-specific
---
