...
description: Essential keyboard shortcuts and productivity tips for Bash and Zsh terminal
  navigation, editing, and history
difficulty: beginner
lastmod: 2026-01-31 10:00:00+00:00
layout: note
permalink: /notes/bash-shortcuts/
source_file: bash-shortcuts.md
tags:
- bash
- terminal
- shortcuts
- productivity
- zsh
title: Use arrow keys + Ctrl for word jumping
---
## Cursor Navigation
