...
- ai-tooling
comments: true
created: 2024-02-10 23:51:11.480000+00:00
date: 2026-03-29 12:00:00+00:00
description: AI-native Jekyll theme for GitHub Pages — Docker-first development, AI-powered
  installation, multi-agent integration (Copilot, Codex, Cursor, Claude), AI preview-image
  generation, and AIEO content optimization with Bootstrap 5.3.
draft: false
excerpt: AI-native Jekyll theme for GitHub Pages — multi-agent ready (Copilot, Codex,
  Cursor, Claude), AI-powered install & preview images, AIEO-optimized, with Docker-first
  development and 43 documented features
...
lastmod: 2026-06-16 15:04:08+00:00
layout: landing
mermaid: true
permalink: /
