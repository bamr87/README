...
description: GitHub Pages compatible Jekyll theme with Bootstrap 5.3, featuring automated
  installation and comprehensive documentation.
draft: false
excerpt: Professional Jekyll theme for GitHub Pages with Bootstrap 5.3, automated
  installation, and 43 documented features
...
- remote-theme
- github-pages
lastmod: 2026-04-06 19:49:20+00:00
layout: landing
mermaid: true
permalink: /
...
| Metric | Value |
|--------|-------|
| **Current Version** | 0.22.10 ([RubyGems](https://rubygems.org/gems/jekyll-theme-zer0), [CHANGELOG](/CHANGELOG)) |
...
**v0.22.10** • [Changelog](CHANGELOG.md) • [License](LICENSE) • [Contributing](CONTRIBUTING.md)
