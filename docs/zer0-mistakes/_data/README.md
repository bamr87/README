...
title: 📊 Zer0-Mistakes Data Directory
---
# 📊 Zer0-Mistakes Data Directory
...
**Build integration:** Statistics refresh automatically before each build:
- `_plugins/content_statistics_generator.rb` — Jekyll hook (local/non-safe builds)
- `scripts/generate-content-statistics.sh` — pre-build step (GitHub Pages safe mode, validate, Docker)

Disable the Jekyll hook with `content_statistics.auto_generate: false` in `_config.yml`.
