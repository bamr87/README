...
title: Consolidated Testing Framework for zer0-mistakes Jekyll Theme
---
...
# …as CI runs it (3 workers, file-level parallelism)
PLAYWRIGHT_PROJECT=critical PLAYWRIGHT_WORKERS=3 ./test/test_playwright.sh
