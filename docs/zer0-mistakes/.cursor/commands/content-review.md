---
agent: agent
description: Review new/changed Jekyll content for SEO, consistency, polish, accessibility,
  and technical accuracy (per-collection)
mode: agent
source_file: content-review.md
title: Content Review for Zer0-Mistakes
tools:
- run_in_terminal
- read_file
- grep_search
