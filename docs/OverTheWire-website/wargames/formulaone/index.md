...
*The source code for the first level can be accessed by logging in to a wargame hosted on the same server. Your first task is figuring out which wargame that is.*
