...
summary: Review open changes, run appropriate tests, create/update documentation,
  update the changelog, bump the version according to semantic versioning, and prepare
  for publication.
tags:
- python
- javascript
