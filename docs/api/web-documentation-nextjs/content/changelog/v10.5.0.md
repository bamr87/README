---
category: api
date: 2024-10-21 14:11:32.627000+00:00
description: Discover the key features and enhancements in Version 10.5.0, including
  new options for content management and improved language file handling.
fmContentType: changelog
last_updated: null
lastmod: 2024-10-21 14:11:32.627000+00:00
slug: v10.5.0
source_file: v10.5.0.md
summary: You can now exclude specific path(s) from the content folder by specifying
  a list of paths in the excludePaths option. You can make use of wildcards to exclude
  folders.
tags:
- api
- api
