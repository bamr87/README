---
category: api
date: 2023-12-12 08:32:08.859000+00:00
description: Learn about the new localization support, custom script enhancements,
  and more in the Version 9.4.0 release notes of Front Matter CMS.
last_updated: null
lastmod: 2023-12-12 15:37:20.732000+00:00
slug: v9.4.0
source_file: v9.4.0.md
summary: 'Now both the webviews and the extension dialogs, messages, and notifications
  are localized. Currently we support the following languages:'
tags:
- azure
- api
- api
