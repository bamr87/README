---
category: api
date: 2022-05-24 06:30:00.754000+00:00
description: A minor release with great enhancements for your content management experience.
last_updated: null
lastmod: 2022-05-24 06:30:01.213000+00:00
source_file: v7.3.0.md
summary: 'Custom actions now allow you to define the command to use for your script
  execution. This new command property, allows you to use any type of scripts like:
  Node.js, Python, Bash, etc.'
tags:
- python
- javascript
- api
