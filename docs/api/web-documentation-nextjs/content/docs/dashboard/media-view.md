...
description: null
last_updated: null
lastmod: 2024-08-07 12:33:01.748000+00:00
slug: dashboard/media-view
source_file: media-view.md
summary: 'The media view has been created to make it easier to look at all media files
  available for your

  articles. When you click on an image, it will show a lightbox, so that it is easier
  to glance at
