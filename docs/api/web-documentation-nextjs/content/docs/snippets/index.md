---
category: api
date: 2022-03-04 14:40:10.952000+00:00
description: null
last_updated: null
lastmod: 2024-06-20 08:45:46.463000+00:00
slug: snippets
source_file: index.md
summary: 'Snippets are a predefined chunk of code/text that can be used to insert
  in your content. It

  provides the editor an easy way to add various elements to the content that is defined
  for your
