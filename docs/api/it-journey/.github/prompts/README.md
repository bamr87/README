...
last_updated: null
lastmod: 2025-11-14 00:00:00+00:00
layout: default
permalink: /github/prompts/readme/
source_file: README.md
summary: This directory houses the reusable prompt blueprints that power ITJourney's
  internal AI agents. Each prompt documents an endtoend operating protocol (mission,
  intake checklist, output format, quality ...
tags:
- testing
- api
title: .github/prompts
---
