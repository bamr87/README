---
title: Reduce If Nonexhaustive Poisoned Deps.Expect
category: misc
tags:
- javascript
last_updated: null
source_file: reduce-if-nonexhaustive-poisoned-deps.expect.md
---
# Reduce If Nonexhaustive Poisoned Deps.Expect
