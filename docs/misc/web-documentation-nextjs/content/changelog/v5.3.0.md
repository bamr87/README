...
description: In this v5.3.0 release of Front Matter we got some great new features
  to announce to you.
last_updated: null
lastmod: '2021-10-28T09:46:53.831Z'
source_file: v5.3.0.md
summary: Custom draft status is now supported with the new frontMatter.content.draftField
  setting.
tags:
- documentation
title: V5.3.0
