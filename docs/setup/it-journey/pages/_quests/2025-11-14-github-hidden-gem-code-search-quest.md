...
preview: Discover GitHub Pages' power to transform repositories into websites and
  capture AI dialogues for eternity
...
source_file: 2025-11-14-github-hidden-gem-code-search-quest.md
sub-title: 'Level 0011 (3) Quest: Web Publishing and AI Capture Mastery'
summary: In the vast digital kingdom of GitHub, where code warriors forge alliances
  and battle bugs, a legendary artifact awaits discovery—the Hidden Gem known as GitHub
  Pages. Powered by the mystical Ruby enc...
tags:
- azure
- testing
- setup
...
- Step 3: To awaken Jekyll fully, add a "Gemfile" for Ruby dependencies (though GitHub Pages auto-handles this, it's wise for local mastery):
  ```
...
- Step 5: Preview your creation locally. In VS Code terminal, run `bundle exec jekyll serve`. Open the local URL (usually http://localhost:4000) in your browser via Live Server extension for real-time edits.
...
- [GitHub Pages Quickstart](https://www.youtube.com/results?search_query=github+pages+jekyll) - Video tutorials
- [VS Code for Web Development](https://code.visualstudio.com/docs/languages/html) - VS Code web development guide

### 💬 Community and Support
- [GitHub Community Forum](https://github.community/c/pages/24) - GitHub Pages discussions
- [Jekyll Talk](https://talk.jekyllrb.com/) - Jekyll community forum
- [VS Code Community](https://stackoverflow.com/questions/tagged/visual-studio-code) - VS Code Q&A

### 🔧 Tools and Extensions
- [Jekyll Themes](https://jekyllthemes.io/) - Free and premium Jekyll themes
- [GitHub Pages Gem](https://github.com/github/pages-gem) - Local GitHub Pages development
- [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) - Advanced Markdown preview

### 📋 Cheat Sheets and References
- [Jekyll Cheat Sheet](https://jekyllrb.com/docs/cheat-sheet/) - Quick Jekyll reference
- [GitHub Flavored Markdown](https://github.github.com/gfm/) - Extended Markdown syntax
- [VS Code Keyboard Shortcuts](https://code.visualstudio.com/shortcuts/keyboard-shortcuts-macos.pdf) - VS Code shortcuts
