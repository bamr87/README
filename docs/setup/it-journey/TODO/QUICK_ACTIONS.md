...
- [ ] Replace description with: "Complete step-by-step guide to install Nerd Fonts on macOS, Linux & Windows. Transform your terminal with icons, symbols, and visual themes. 20-minute setup tutorial with troubleshooting."
- [ ] Add preview field
- [ ] Update keywords section

#### 2. Bootable macOS Critical Fix
**File**: `/pages/_posts/2024-03-27-bootable-mac-os.md`  
- [ ] Change title to: "Create Bootable macOS Installer: Complete Guide for Recovery & Installation"
- [ ] Add description: "Step-by-step tutorial to create bootable macOS installers using Terminal. Includes commands for Sonoma, Ventura, Monterey & older versions. Perfect for system recovery and clean installs."
- [ ] Remove `draft: true` status
- [ ] Add proper tags and categories

#### 3. Zero-CTR Emergency Fixes
- [ ] Jekyll Mermaid docs - add compelling description
- [ ] SEC Edgar post - update for modern relevance  
- [ ] Desktop Widgets - match search intent
- [ ] Auto-increment frontmatter - developer-focused description

### 📝 Templates & Standards
- [ ] Create frontmatter template file
