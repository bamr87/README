...
summary: This directory contains the infrastructure for building and deploying the
  parodynews Sphinx documentation as a containerized service.
tags:
- python
- docker
- api
- testing
- setup
title: Sphinx Documentation Deployment
---
