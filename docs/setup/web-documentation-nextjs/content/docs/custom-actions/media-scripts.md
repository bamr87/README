...
description: null
last_updated: null
lastmod: 2024-08-13 07:40:24.192000+00:00
slug: custom-actions/media-scripts
source_file: media-scripts.md
summary: 'Media scripts are scripts that can be executed on a single or multiple media
  files.

  You can use these scripts to manipulate media files, copy metadata, or perform any
  other operation
