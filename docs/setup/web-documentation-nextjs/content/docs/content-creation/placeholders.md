---
category: setup
date: 2022-03-14 08:42:21.626000+00:00
description: Learn how to use placeholders in Front Matter CMS
last_updated: null
lastmod: 2025-07-01 07:25:48.353000+00:00
slug: content-creation/placeholders
source_file: placeholders.md
summary: 'Placeholders can be used in fields, slug templates, preview paths, and file
  prefix settings.

  These placeholders allow you to generate dynamic values based on the front matter
  fields or other
