---
category: setup
date: 2023-04-01 12:41:24.675000+00:00
description: Projects are useful when managing multiple sites or when you want to
  separate your content into different environments.
last_updated: null
lastmod: 2024-02-26 17:54:08.454000+00:00
slug: settings/projects
source_file: projects.md
summary: 'Projects are useful when managing multiple sites or when you want to separate
  your content

  into different environments. For instance, when you are using Front Matter in a
  monorepo with
