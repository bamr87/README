---
category: setup
date: 2023-04-01 10:16:59.392000+00:00
description: UI extensibility in the Front Matter extension.
last_updated: null
lastmod: 2024-08-13 08:16:56.806000+00:00
slug: ui-extensibility
source_file: index.md
summary: 'As every user has different needs, the Front Matter extension allows you
  to extend the UI with your

  own custom elements and components which can be used in the Front Matter dashboards
  and the panel.'
tags:
- javascript
- setup
