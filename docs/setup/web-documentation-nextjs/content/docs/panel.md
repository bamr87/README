...
description: Learn how to use the Front Matter panel to perform most of the extension
  actions with just a click on the button.
last_updated: null
lastmod: 2025-02-27 11:02:41.931000+00:00
slug: panel
source_file: panel.md
summary: 'The Front Matter panel allows you to perform most of the extension actions
  by just a click on the
