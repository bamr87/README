---
category: setup
date: 2023-02-13 19:10:04.012000+00:00
description: FrontMatter is back and better than ever with its latest release, version
  8.3.0! This update is packed with new features and improvements, including external
  config support, allowing you to easily import configurations from external files.
  Plus, with VSCode theme support, you can customize your development environment
  to your heart's content. But that's not all - there are many other exciting additions
  and enhancements waiting for you. Check out the release notes to see what's new
  and upgrade to FrontMatter 8.3.0 today!
last_updated: null
lastmod: 2024-09-16 12:12:54.097000+00:00
slug: v8.3.0
source_file: v8.3.0.md
summary: In this version of VSCode Front Matter now supports external config files,
  meaning you can store your configurations outside of the extension in a separate
  file. This allows for better organization an...
tags:
- testing
- setup
title: V8.3.0
