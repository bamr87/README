...
description: In this v6.0.0 release of Front Matter we got some great new features
  to announce to you.
last_updated: null
lastmod: '2022-01-25T15:21:15.254Z'
source_file: v6.0.0.md
summary: Data files/folders are pieces of content that do not belong to any markdown
  content, but live on their own. Most of the time, these data files are used to store
  additional information about your proje...
tags:
- setup
title: V6.0.0
---
