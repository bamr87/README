...
- v8.2.0
category: setup
date: 2022-12-08 15:45:51.509000+00:00
description: Check out the features/enhancements/fixes that we packed in version 8.2.0
  of Front Matter.
last_updated: null
lastmod: 2024-04-30 08:08:50.695000+00:00
slug: v8.2.0
source_file: v8.2.0.md
summary: You can now define conditional UI for your contenttype fields. This means
  that you can now show/hide fields based on the value of another field.
tags:
- setup
title: V8.2.0
type: changelog
