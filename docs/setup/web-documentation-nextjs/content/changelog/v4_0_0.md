---
category: setup
date: 2021-09-20 11:51:43.926000+00:00
description: In this new major release of Front Matter, we got some great new features
  to announce to you.
last_updated: null
lastmod: 2024-04-30 08:04:33.782000+00:00
source_file: v4_0_0.md
summary: As Front Matter is not a singleuser extension, we wanted to bring it to a
  higher level. With the new Team level settings functionality, you can manage your
  site by sharing the configuration on the tea...
tags:
- setup
title: V4 0 0
---
