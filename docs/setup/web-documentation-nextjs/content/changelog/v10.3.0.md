---
category: setup
date: 2024-08-13 13:35:51.751000+00:00
description: 'Version 10.3.0 release notes: GitHub Copilot integration, select all
  items, UI extensibility GA, field actions, copy metadata/delete media files, and
  more.'
fmContentType: changelog
last_updated: null
lastmod: 2024-08-13 15:32:24.043000+00:00
slug: v10.3.0
source_file: v10.3.0.md
summary: In the July 2024 release of Visual Studio Code, extension developers are
  able to make use of the GitHub Copilot's Large Language Model (LLM). Front Matter
  CMS took advantage of this feature to provide...
tags:
- azure
- api
- setup
