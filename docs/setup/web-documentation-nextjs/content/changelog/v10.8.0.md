...
description: Discover the key features and enhancements in Front Matter CMS version
  10.8.0, including new settings and improved filename sanitization.
fmContentType: changelog
last_updated: null
lastmod: 2025-02-27 11:13:29.896000+00:00
slug: v10.8.0
source_file: v10.8.0.md
summary: You can now subscribe to the Front Matter CMS changelog using the new RSS
  feed. This feed will keep you up to date with the latest changes and enhancements.
tags:
- api
- testing
- setup
