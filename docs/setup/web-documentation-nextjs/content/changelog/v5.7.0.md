...
description: In this v5.7.0 release of Front Matter we got some great new features
  to announce to you.
last_updated: null
lastmod: '2021-12-06T16:24:43.812Z'
source_file: v5.7.0.md
summary: To help out content editors write their content in Markdown. Front Matter
  provides a couple of helpful, what you see is what you get (WYSIWYG), controls while
  working in a Markdown file.
tags:
- setup
title: V5.7.0
---
