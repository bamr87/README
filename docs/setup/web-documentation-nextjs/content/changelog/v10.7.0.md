...
description: Discover the new features in Version 10.7.0, including GitHub Copilot
  prompts, media actions, and enhanced SEO panel improvements.
fmContentType: changelog
last_updated: null
lastmod: 2024-12-31 14:22:39.496000+00:00
slug: v10.7.0
source_file: v10.7.0.md
summary: You are now able to prompt GitHub Copilot straight from your custom script/action.
  This functionality allows you to use the power of AI to generate titles, descriptions,
