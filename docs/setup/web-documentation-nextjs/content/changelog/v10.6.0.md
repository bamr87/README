---
category: setup
date: 2024-11-06 09:53:37.985000+00:00
description: Discover the key updates in Version 10.6.0, including enhanced navigation,
  dynamic node path evaluation, and improved git diff mode functionality.
fmContentType: changelog
last_updated: null
lastmod: 2024-11-06 09:53:47.913000+00:00
slug: v10.6.0
source_file: v10.6.0.md
summary: The select all button now works while navigating through pages. This means
  that if you have a selection present and you navigate to another page, you can still
  use the select all button or select indi...
tags:
- javascript
- setup
title: V10.6.0
