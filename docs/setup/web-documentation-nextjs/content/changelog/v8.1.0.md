...
- v8.1.0
category: setup
date: 2022-09-22 06:19:40.486000+00:00
description: Check out the features/enhancements/fixes that we packed in version 8.1.0
  of Front Matter.
last_updated: null
lastmod: 2022-09-22 06:19:41.565000+00:00
slug: v8.1.0
source_file: v8.1.0.md
summary: Are you using git to manage your content? If so, then we have great news
  for you! We have added a simple git integration that will allow you to sync your
  changes from and to your git repository.
tags:
- javascript
- testing
- setup
