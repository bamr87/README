...
VS Code Copilot-optimized documentation standards and Markdown formatting guidelines for Django/OpenAI projects.
...
**Usage:** Reference for all documentation creation, README maintenance, and technical writing in Django/OpenAI projects. Emphasizes Django best practices, OpenAI integration documentation, and container-first development documentation.
