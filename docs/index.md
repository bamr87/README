...
Jekyll theme and software architecture patterns for GitHub Pages. *(727 documents, 98 sections)*

[Content map](browse/zer0-mistakes.md)

### [Barodybroject](barodybroject/README.md)

Full-stack application platform with infrastructure, testing, and deployment tooling. *(307 documents, 56 sections)*
