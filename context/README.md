...
|---|---|---|---|---|---|
| [it-journey](cards/it-journey.md) | site | active | 1166 | 93 | Educational IT platform with quests, blog posts, and technical documentation. |
| [zer0-mistakes](cards/zer0-mistakes.md) | theme | active | 724 | 96 | Jekyll theme and software architecture patterns for GitHub Pages. |
| [barodybroject](cards/barodybroject.md) | app | active | 301 | 56 | Full-stack application platform with infrastructure, testing, and deployment tooling. |
...
- Corpus: [`docs/it-journey/`](../docs/it-journey/) (1166 documents)
...
- Corpus: [`docs/zer0-mistakes/`](../docs/zer0-mistakes/) (724 documents)
- Navigation: [tree](nav/zer0-mistakes.json) · [content map](../docs/browse/zer0-mistakes.md) — 644 pages in 96 sections
...
- Corpus: [`docs/barodybroject/`](../docs/barodybroject/) (301 documents)
