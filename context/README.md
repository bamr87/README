...
| [barodybroject](cards/barodybroject.md) | app | active | 304 | Full-stack application platform with infrastructure, testing, and deployment tooling. |
| [bashcrawl](cards/bashcrawl.md) | game | active | 45 | Interactive shell-scripting tutorial — learn Bash by exploring a dungeon. |
| [zer0-mistakes](cards/zer0-mistakes.md) | theme | active | 676 | Jekyll theme and software architecture patterns for GitHub Pages. |
| [it-journey](cards/it-journey.md) | site | active | 1044 | Educational IT platform with quests, blog posts, and technical documentation. |
...
- Corpus: [`docs/barodybroject/`](../docs/barodybroject/) (304 documents)
...
- Corpus: [`docs/zer0-mistakes/`](../docs/zer0-mistakes/) (676 documents)
...
- Corpus: [`docs/it-journey/`](../docs/it-journey/) (1044 documents)
