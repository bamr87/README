...
| [zer0-mistakes](cards/zer0-mistakes.md) | theme | active | 695 | Jekyll theme and software architecture patterns for GitHub Pages. |
| [it-journey](cards/it-journey.md) | site | active | 1072 | Educational IT platform with quests, blog posts, and technical documentation. |
...
- Corpus: [`docs/zer0-mistakes/`](../docs/zer0-mistakes/) (695 documents)
...
- Corpus: [`docs/it-journey/`](../docs/it-journey/) (1072 documents)
