...
| `_drafts/` | dir | Session hand-off posts drafted for bamr87/it-journey; deleted once published | terminal |
...
| `PLAN.md` | file | v3 redesign plan — five-stage platform, check catalogue, roadmap | |
